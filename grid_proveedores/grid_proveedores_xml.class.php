...
class grid_proveedores_xml
{
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->nombre_proveedor))
         {
             $this->nombre_proveedor = sc_convert_encoding($this->nombre_proveedor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " nombre_proveedor =\"" . $this->trata_dados($this->nombre_proveedor) . "\"";
   }
   //----- telefono_fijo_proveedor
   function NM_export_telefono_fijo_proveedor()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->telefono_fijo_proveedor))
         {
             $this->telefono_fijo_proveedor = sc_convert_encoding($this->telefono_fijo_proveedor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " telefono_fijo_proveedor =\"" . $this->trata_dados($this->telefono_fijo_proveedor) . "\"";
   }
   //----- telefono_celular_proveedor
   function NM_export_telefono_celular_proveedor()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->telefono_celular_proveedor))
         {
             $this->telefono_celular_proveedor = sc_convert_encoding($this->telefono_celular_proveedor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " telefono_celular_proveedor =\"" . $this->trata_dados($this->telefono_celular_proveedor) . "\"";
   }
   //----- direccion_proveedor
   function NM_export_direccion_proveedor()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->direccion_proveedor))
         {
             $this->direccion_proveedor = sc_convert_encoding($this->direccion_proveedor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " direccion_proveedor =\"" . $this->trata_dados($this->direccion_proveedor) . "\"";
   }
   //----- id_usuario
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - proveedores :: XML</TITLE>
