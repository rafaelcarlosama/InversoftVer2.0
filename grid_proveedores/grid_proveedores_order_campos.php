...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["id_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["id_proveedor"] : "Id Proveedor";
   $tab_ger_campos['nombre_proveedor'] = "on";
   $tab_def_campos['nombre_proveedor'] = "Nombre_Proveedor";
   $tab_converte["Nombre_Proveedor"]   = "nombre_proveedor";
   $tab_labels["nombre_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["nombre_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["nombre_proveedor"] : "Nombre Proveedor";
   $tab_ger_campos['telefono_fijo_proveedor'] = "on";
   $tab_def_campos['telefono_fijo_proveedor'] = "Telefono_Fijo_Proveedor";
   $tab_converte["Telefono_Fijo_Proveedor"]   = "telefono_fijo_proveedor";
   $tab_labels["telefono_fijo_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["telefono_fijo_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["telefono_fijo_proveedor"] : "Telefono Fijo Proveedor";
   $tab_ger_campos['telefono_celular_proveedor'] = "on";
   $tab_def_campos['telefono_celular_proveedor'] = "Telefono_Celular_Proveedor";
   $tab_converte["Telefono_Celular_Proveedor"]   = "telefono_celular_proveedor";
   $tab_labels["telefono_celular_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["telefono_celular_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["telefono_celular_proveedor"] : "Telefono Celular Proveedor";
   $tab_ger_campos['direccion_proveedor'] = "on";
   $tab_def_campos['direccion_proveedor'] = "Direccion_Proveedor";
   $tab_converte["Direccion_Proveedor"]   = "direccion_proveedor";
   $tab_labels["direccion_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["direccion_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["direccion_proveedor"] : "Direccion Proveedor";
   $tab_ger_campos['id_usuario'] = "on";
   $tab_def_campos['id_usuario'] = "Id_Usuario";
   $tab_converte["Id_Usuario"]   = "id_usuario";
   $tab_labels["id_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["id_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels']["id_usuario"] : "Id Usuario";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_proveedores']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - proveedores</TITLE>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_proveedores']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_proveedores']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
