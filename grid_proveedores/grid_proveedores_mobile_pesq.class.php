...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_proveedor";$Nm_numeric[] = "id_usuario";$Nm_numeric[] = "id_proveedor";$Nm_numeric[] = "id_usuario";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_telefono_celular_proveedor"  <?php echo $str_hide_telefono_celular_proveedor?>><?php
      $telefono_celular_proveedor_look = substr($this->Db->qstr($telefono_celular_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_proveedor" name="id_proveedor_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_proveedor"  <?php echo $str_display_id_proveedor; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_proveedor_input_2" name="id_proveedor_input_2" value="<?php echo NM_encode_input($id_proveedor_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_proveedor"  <?php echo $str_hide_nombre_proveedor?>><?php
      $nombre_proveedor_look = substr($this->Db->qstr($nombre_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_telefono_fijo_proveedor"  <?php echo $str_hide_telefono_fijo_proveedor?>><?php
      $telefono_fijo_proveedor_look = substr($this->Db->qstr($telefono_fijo_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
