...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - proveedores :: PDF</title>
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_proveedores'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
