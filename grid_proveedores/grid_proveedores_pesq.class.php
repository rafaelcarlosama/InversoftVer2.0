...
class grid_proveedores_pesq
{
    ...
    * @access  public
    */
   function grid_proveedores_pesq()
   {
   }
...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono_celular_proveedor')
      {
          $telefono_celular_proveedor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono_celular_proveedor($telefono_celular_proveedor);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_proveedor')
      {
          $nombre_proveedor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_proveedor($nombre_proveedor);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono_fijo_proveedor')
      {
          $telefono_fijo_proveedor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono_fijo_proveedor($telefono_fijo_proveedor);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_telefono_celular_proveedor($telefono_celular_proveedor)
   {
      $telefono_celular_proveedor = substr($this->Db->qstr($telefono_celular_proveedor), 1, -1);
            $telefono_celular_proveedor_look = substr($this->Db->qstr($telefono_celular_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Celular_Proveedor from " . $this->Ini->nm_tabela . " where  Telefono_Celular_Proveedor like '%" . $telefono_celular_proveedor . "%'"; 
   ...
   function lookup_ajax_nombre_proveedor($nombre_proveedor)
   {
      $nombre_proveedor = substr($this->Db->qstr($nombre_proveedor), 1, -1);
            $nombre_proveedor_look = substr($this->Db->qstr($nombre_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Proveedor from " . $this->Ini->nm_tabela . " where  Nombre_Proveedor like '%" . $nombre_proveedor . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_telefono_fijo_proveedor($telefono_fijo_proveedor)
   {
      $telefono_fijo_proveedor = substr($this->Db->qstr($telefono_fijo_proveedor), 1, -1);
            $telefono_fijo_proveedor_look = substr($this->Db->qstr($telefono_fijo_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Fijo_Proveedor from " . $this->Ini->nm_tabela . " where  Telefono_Fijo_Proveedor like '%" . $telefono_fijo_proveedor . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - proveedores</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_telefono_celular_proveedor_cond#NMF#' + search_get_sel_txt('SC_telefono_celular_proveedor_cond') + '@NMF@';
  str_out += 'SC_telefono_celular_proveedor#NMF#' + search_get_text('SC_telefono_celular_proveedor') + '@NMF@';
  str_out += 'id_ac_telefono_celular_proveedor#NMF#' + search_get_text('id_ac_telefono_celular_proveedor') + '@NMF@';
  ...
  str_out += 'SC_nombre_proveedor_cond#NMF#' + search_get_sel_txt('SC_nombre_proveedor_cond') + '@NMF@';
  str_out += 'SC_nombre_proveedor#NMF#' + search_get_text('SC_nombre_proveedor') + '@NMF@';
  str_out += 'id_ac_nombre_proveedor#NMF#' + search_get_text('id_ac_nombre_proveedor') + '@NMF@';
  str_out += 'SC_telefono_fijo_proveedor_cond#NMF#' + search_get_sel_txt('SC_telefono_fijo_proveedor_cond') + '@NMF@';
  str_out += 'SC_telefono_fijo_proveedor#NMF#' + search_get_text('SC_telefono_fijo_proveedor') + '@NMF@';
  str_out += 'id_ac_telefono_fijo_proveedor#NMF#' + search_get_text('id_ac_telefono_fijo_proveedor') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_nombre_proveedor").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_proveedor",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nombre_proveedor").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_proveedor").val( $(this).val() );
       }
     }
   });
   $("#id_ac_telefono_fijo_proveedor").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono_fijo_proveedor",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_telefono_fijo_proveedor").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_telefono_fijo_proveedor").val( $(this).val() );
       }
     }
   });
   $("#id_ac_telefono_celular_proveedor").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono_celular_proveedor",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_telefono_celular_proveedor").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_telefono_celular_proveedor").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - proveedores</span></td>
...
<?php
   ...
   {
      global 
             $telefono_celular_proveedor_cond, $telefono_celular_proveedor, $telefono_celular_proveedor_autocomp,
             $id_proveedor_cond, $id_proveedor, $id_proveedor_input_2, $id_proveedor_autocomp,
             $nombre_proveedor_cond, $nombre_proveedor, $nombre_proveedor_autocomp,
             $telefono_fijo_proveedor_cond, $telefono_fijo_proveedor, $telefono_fijo_proveedor_autocomp,
      ...
      { 
          ...
          $telefono_celular_proveedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_celular_proveedor']; 
          $telefono_celular_proveedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_celular_proveedor_cond']; 
          $id_proveedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor']; 
          $id_proveedor_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor_input_2']; 
          $id_proveedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor_cond']; 
          $nombre_proveedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['nombre_proveedor']; 
          $nombre_proveedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['nombre_proveedor_cond']; 
          $telefono_fijo_proveedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_fijo_proveedor']; 
          $telefono_fijo_proveedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_fijo_proveedor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['NM_operador']; 
      } 
      if (!isset($telefono_celular_proveedor_cond) || empty($telefono_celular_proveedor_cond))
      {
         $telefono_celular_proveedor_cond = "qp";
      }
      if (!isset($id_proveedor_cond) || empty($id_proveedor_cond))
      {
         $id_proveedor_cond = "gt";
      }
      if (!isset($nombre_proveedor_cond) || empty($nombre_proveedor_cond))
      {
         $nombre_proveedor_cond = "qp";
      }
      if (!isset($telefono_fijo_proveedor_cond) || empty($telefono_fijo_proveedor_cond))
      {
         $telefono_fijo_proveedor_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_telefono_celular_proveedor = (in_array($telefono_celular_proveedor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_proveedor = (in_array($id_proveedor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_proveedor = (in_array($nombre_proveedor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_telefono_fijo_proveedor = (in_array($telefono_fijo_proveedor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_proveedor = ('bw' == $id_proveedor_cond) ? $display_aberto : $display_fechado;

      if (!isset($telefono_celular_proveedor) || $telefono_celular_proveedor == "")
      {
          $telefono_celular_proveedor = "";
      }
      if (isset($telefono_celular_proveedor) && !empty($telefono_celular_proveedor))
      {
         $tmp_pos = strpos($telefono_celular_proveedor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono_celular_proveedor = substr($telefono_celular_proveedor, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nombre_proveedor) || $nombre_proveedor == "")
      {
          $nombre_proveedor = "";
      }
      if (isset($nombre_proveedor) && !empty($nombre_proveedor))
      {
         $tmp_pos = strpos($nombre_proveedor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_proveedor = substr($nombre_proveedor, 0, $tmp_pos);
         }
      }
      if (!isset($telefono_fijo_proveedor) || $telefono_fijo_proveedor == "")
      {
          $telefono_fijo_proveedor = "";
      }
      if (isset($telefono_fijo_proveedor) && !empty($telefono_fijo_proveedor))
      {
         $tmp_pos = strpos($telefono_fijo_proveedor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono_fijo_proveedor = substr($telefono_fijo_proveedor, 0, $tmp_pos);
         }
      }
?>
 <?php
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['telefono_celular_proveedor'])) ? $this->New_label['telefono_celular_proveedor'] : "Telefono Celular Proveedor"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_telefono_celular_proveedor_cond" name="telefono_celular_proveedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_celular_proveedor'), this, 'telefono_celular_proveedor')">
       <OPTION value="qp" <?php if ("qp" == $telefono_celular_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_celular_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_celular_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_celular_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono_celular_proveedor" <?php echo $str_hide_telefono_celular_proveedor?> valign="top">
 ...
 $nmgp_tab_label .= "telefono_celular_proveedor?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $telefono_celular_proveedor_look = substr($this->Db->qstr($telefono_celular_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Celular_Proveedor from " . $this->Ini->nm_tabela . " where Telefono_Celular_Proveedor = '$telefono_celular_proveedor_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$telefono_celular_proveedor]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$telefono_celular_proveedor];
      }
      else
      {
          $sAutocompValue = $telefono_celular_proveedor;
      }
?>
<INPUT  type="text" id="SC_telefono_celular_proveedor" name="telefono_celular_proveedor" value="<?php echo NM_encode_input($telefono_celular_proveedor) ?>" size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_telefono_celular_proveedor" name="telefono_celular_proveedor_autocomp" size="40" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_proveedor'])) ? $this->New_label['id_proveedor'] : "Id Proveedor"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_proveedor_cond" name="id_proveedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_proveedor'), this, 'id_proveedor')">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_proveedor" name="id_proveedor_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_proveedor"  <?php echo $str_display_id_proveedor; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_proveedor_input_2" name="id_proveedor_input_2" value="<?php echo NM_encode_input($id_proveedor_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_proveedor'])) ? $this->New_label['nombre_proveedor'] : "Nombre Proveedor"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_proveedor_cond" name="nombre_proveedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_proveedor'), this, 'nombre_proveedor')">
       <OPTION value="qp" <?php if ("qp" == $nombre_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_proveedor" <?php echo $str_hide_nombre_proveedor?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombre_proveedor'])) ? $this->New_label['nombre_proveedor'] : "Nombre Proveedor";
 $nmgp_tab_label .= "nombre_proveedor?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $nombre_proveedor_look = substr($this->Db->qstr($nombre_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Proveedor from " . $this->Ini->nm_tabela . " where Nombre_Proveedor = '$nombre_proveedor_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nombre_proveedor]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_proveedor];
      }
      else
      {
          $sAutocompValue = $nombre_proveedor;
      }
?>
<INPUT  type="text" id="SC_nombre_proveedor" name="nombre_proveedor" value="<?php echo NM_encode_input($nombre_proveedor) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_proveedor" name="nombre_proveedor_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['telefono_fijo_proveedor'])) ? $this->New_label['telefono_fijo_proveedor'] : "Telefono Fijo Proveedor"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_telefono_fijo_proveedor_cond" name="telefono_fijo_proveedor_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_fijo_proveedor'), this, 'telefono_fijo_proveedor')">
       <OPTION value="qp" <?php if ("qp" == $telefono_fijo_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_fijo_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_fijo_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_fijo_proveedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono_fijo_proveedor" <?php echo $str_hide_telefono_fijo_proveedor?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['telefono_fijo_proveedor'])) ? $this->New_label['telefono_fijo_proveedor'] : "Telefono Fijo Proveedor";
 $nmgp_tab_label .= "telefono_fijo_proveedor?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $telefono_fijo_proveedor_look = substr($this->Db->qstr($telefono_fijo_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Fijo_Proveedor from " . $this->Ini->nm_tabela . " where Telefono_Fijo_Proveedor = '$telefono_fijo_proveedor_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$telefono_fijo_proveedor]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$telefono_fijo_proveedor];
      }
      else
      {
          $sAutocompValue = $telefono_fijo_proveedor;
      }
?>
<INPUT  type="text" id="SC_telefono_fijo_proveedor" name="telefono_fijo_proveedor" value="<?php echo NM_encode_input($telefono_fijo_proveedor) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_telefono_fijo_proveedor" name="telefono_fijo_proveedor_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_telefono_celular_proveedor'), document.F1.telefono_celular_proveedor_cond, 'telefono_celular_proveedor');
   document.F1.telefono_celular_proveedor.value = "";
   document.F1.telefono_celular_proveedor_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_nombre_proveedor'), document.F1.nombre_proveedor_cond, 'nombre_proveedor');
   document.F1.nombre_proveedor.value = "";
   document.F1.nombre_proveedor_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_telefono_fijo_proveedor'), document.F1.telefono_fijo_proveedor_cond, 'telefono_fijo_proveedor');
   document.F1.telefono_fijo_proveedor.value = "";
   document.F1.telefono_fijo_proveedor_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "inversoft/grid_proveedores";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_telefono_celular_proveedor_cond'] = 'cond';
      $tp_fields['SC_telefono_celular_proveedor'] = 'text_aut';
      $tp_fields['id_ac_telefono_celular_proveedor'] = 'text_aut';
      ...
      $tp_fields['SC_nombre_proveedor_cond'] = 'cond';
      $tp_fields['SC_nombre_proveedor'] = 'text_aut';
      $tp_fields['id_ac_nombre_proveedor'] = 'text_aut';
      $tp_fields['SC_telefono_fijo_proveedor_cond'] = 'cond';
      $tp_fields['SC_telefono_fijo_proveedor'] = 'text_aut';
      $tp_fields['id_ac_telefono_fijo_proveedor'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $telefono_celular_proveedor_cond, $telefono_celular_proveedor, $telefono_celular_proveedor_autocomp,
             $id_proveedor_cond, $id_proveedor, $id_proveedor_input_2, $id_proveedor_autocomp,
             $nombre_proveedor_cond, $nombre_proveedor, $nombre_proveedor_autocomp,
             $telefono_fijo_proveedor_cond, $telefono_fijo_proveedor, $telefono_fijo_proveedor_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($telefono_celular_proveedor_autocomp) && empty($telefono_celular_proveedor))
      {
          $telefono_celular_proveedor = $telefono_celular_proveedor_autocomp;
      }
      if (!empty($id_proveedor_autocomp) && empty($id_proveedor))
      {
          $id_proveedor = $id_proveedor_autocomp;
      }
      if (!empty($nombre_proveedor_autocomp) && empty($nombre_proveedor))
      {
          $nombre_proveedor = $nombre_proveedor_autocomp;
      }
      if (!empty($telefono_fijo_proveedor_autocomp) && empty($telefono_fijo_proveedor))
      {
          $telefono_fijo_proveedor = $telefono_fijo_proveedor_autocomp;
      }
      $telefono_celular_proveedor_cond_salva = $telefono_celular_proveedor_cond; 
      if (!isset($telefono_celular_proveedor_input_2) || $telefono_celular_proveedor_input_2 == "")
      {
          $telefono_celular_proveedor_input_2 = $telefono_celular_proveedor;
      }
      ...
      $nombre_proveedor_cond_salva = $nombre_proveedor_cond; 
      if (!isset($nombre_proveedor_input_2) || $nombre_proveedor_input_2 == "")
      {
          $nombre_proveedor_input_2 = $nombre_proveedor;
      }
      $telefono_fijo_proveedor_cond_salva = $telefono_fijo_proveedor_cond; 
      if (!isset($telefono_fijo_proveedor_input_2) || $telefono_fijo_proveedor_input_2 == "")
      {
          $telefono_fijo_proveedor_input_2 = $telefono_fijo_proveedor;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_celular_proveedor'] = $telefono_celular_proveedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_celular_proveedor_cond'] = $telefono_celular_proveedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor'] = $id_proveedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor_input_2'] = $id_proveedor_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['id_proveedor_cond'] = $id_proveedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['nombre_proveedor'] = $nombre_proveedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['nombre_proveedor_cond'] = $nombre_proveedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_fijo_proveedor'] = $telefono_fijo_proveedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['campos_busca']['telefono_fijo_proveedor_cond'] = $telefono_fijo_proveedor_cond_salva; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono_celular_proveedor'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['telefono_celular_proveedor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono_celular_proveedor'] = $telefono_celular_proveedor;
      }
      $id_proveedor_look = substr($this->Db->qstr($id_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_proveedor))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_proveedor'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_proveedor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_proveedor'] = $nombre_proveedor;
      }
      $telefono_fijo_proveedor_look = substr($this->Db->qstr($telefono_fijo_proveedor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Fijo_Proveedor from " . $this->Ini->nm_tabela . " where Telefono_Fijo_Proveedor = '$telefono_fijo_proveedor_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono_fijo_proveedor'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['telefono_fijo_proveedor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono_fijo_proveedor'] = $telefono_fijo_proveedor;
      }

      //----- $telefono_celular_proveedor
      $this->Date_part = false;
      if (isset($telefono_celular_proveedor) || $telefono_celular_proveedor_cond == "nu" || $telefono_celular_proveedor_cond == "nn" || $telefono_celular_proveedor_cond == "ep" || $telefono_celular_proveedor_cond == "ne")
      {
         $this->monta_condicao("Telefono_Celular_Proveedor", $telefono_celular_proveedor_cond, $telefono_celular_proveedor, "", "telefono_celular_proveedor");
      }
      ...
      //----- $nombre_proveedor
      $this->Date_part = false;
      if (isset($nombre_proveedor) || $nombre_proveedor_cond == "nu" || $nombre_proveedor_cond == "nn" || $nombre_proveedor_cond == "ep" || $nombre_proveedor_cond == "ne")
      {
         $this->monta_condicao("Nombre_Proveedor", $nombre_proveedor_cond, $nombre_proveedor, "", "nombre_proveedor");
      }

      //----- $telefono_fijo_proveedor
      $this->Date_part = false;
      if (isset($telefono_fijo_proveedor) || $telefono_fijo_proveedor_cond == "nu" || $telefono_fijo_proveedor_cond == "nn" || $telefono_fijo_proveedor_cond == "ep" || $telefono_fijo_proveedor_cond == "ne")
      {
         $this->monta_condicao("Telefono_Fijo_Proveedor", $telefono_fijo_proveedor_cond, $telefono_fijo_proveedor, "", "telefono_fijo_proveedor");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['where_pesq_ant'] = $this->comando . $this->comando_fim;
