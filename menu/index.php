...
{
    db_conect_devel($_SESSION['scriptcase']['menu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu']['glo_nm_path_prod'], 'inversoft', 2); 
}
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
{ 
   $this->Db = db_conect_devel($_SESSION['scriptcase']['menu']['glo_nm_conexao'], $str_root . $_SESSION['scriptcase']['menu']['glo_nm_path_prod'], 'inversoft'); 
} 
else 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("blank_fondo_inicial") . "/blank_fondo_inicial_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_fondo_inicial']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_fondo_inicial'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_clientes") . "/form_clientes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_ingreso_producto") . "/form_ingreso_producto_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso_producto']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_ingreso_producto") . "/grid_ingreso_producto_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ingreso_producto']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tipo_documento") . "/form_tipo_documento_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_documento']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tipo_documento") . "/grid_tipo_documento_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_documento']))
    {
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[11]))
{
 ...
 $nm_var_lab[12] = "Ingreso_Producto";
...
{
    $menu_menuData['data'] .= "item_2|..|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_productos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_2|..|" . $nm_var_lab[1] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) == "on")
{
    $menu_menuData['data'] .= "item_3|..|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_productos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']) == "on")
{
    $menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[4] . "|menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_5|..|" . $nm_var_lab[4] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) == "on")
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_7|.|" . $nm_var_lab[6] . "||" . $nm_var_hint[6] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_proveedores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_proveedores']) == "on")
{
    $menu_menuData['data'] .= "item_8|..|" . $nm_var_lab[7] . "|menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_proveedores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_8|..|" . $nm_var_lab[7] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) == "on")
{
    $menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "|menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_proveedores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_10|.|" . $nm_var_lab[9] . "||" . $nm_var_hint[9] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_pedidos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pedidos']) == "on")
{
    $menu_menuData['data'] .= "item_11|..|" . $nm_var_lab[10] . "|menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_pedidos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_11|..|" . $nm_var_lab[10] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) == "on")
{
    $menu_menuData['data'] .= "item_12|..|" . $nm_var_lab[11] . "|menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_pedidos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_12|..|" . $nm_var_lab[11] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_13|.|" . $nm_var_lab[12] . "||" . $nm_var_hint[12] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso_producto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso_producto']) == "on")
{
    $menu_menuData['data'] .= "item_14|..|" . $nm_var_lab[13] . "|menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=form_ingreso_producto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_14|..|" . $nm_var_lab[13] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ingreso_producto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ingreso_producto']) == "on")
{
    $menu_menuData['data'] .= "item_15|..|" . $nm_var_lab[14] . "|menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_ingreso_producto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[14] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_15|..|" . $nm_var_lab[14] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_19|.|" . $nm_var_lab[15] . "||" . $nm_var_hint[15] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) == "on")
{
    $menu_menuData['data'] .= "item_20|..|" . $nm_var_lab[16] . "|menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=form_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_20|..|" . $nm_var_lab[16] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_categorias']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_categorias']) == "on")
{
    $menu_menuData['data'] .= "item_21|..|" . $nm_var_lab[17] . "|menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=grid_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[17] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_21|..|" . $nm_var_lab[17] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_33|.|" . $nm_var_lab[18] . "||" . $nm_var_hint[18] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_documento']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_documento']) == "on")
{
    $menu_menuData['data'] .= "item_34|..|" . $nm_var_lab[19] . "|menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_tipo_documento&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "|scriptcase__NM__ico__NM__add_16.png|" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_34|..|" . $nm_var_lab[19] . "|||scriptcase__NM__ico__NM__add_16.png|_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_documento']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_documento']) == "on")
{
    $menu_menuData['data'] .= "item_35|..|" . $nm_var_lab[20] . "|menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_tipo_documento&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[20] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_35|..|" . $nm_var_lab[20] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_22|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_list_users'] . "|menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_23|..|" . $this->Nm_lang['lang_list_users'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_24|..|" . $this->Nm_lang['lang_list_apps'] . "||||_self|disabled\n";
}
...
{
    $menu_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_25|..|" . $this->Nm_lang['lang_list_groups'] . "||||_self|disabled\n";
}
...
{
    $menu_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_26|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_27|..|" . $this->Nm_lang['lang_list_sync_apps'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_28|..|" . $this->Nm_lang['lang_change_pswd'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_menuData['data'] .= "item_29|.|" . $this->Nm_lang['lang_exit'] . "|menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_target('_parent') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_29|.|" . $this->Nm_lang['lang_exit'] . "||||_parent|disabled\n";
}
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=form_productos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_productos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=form_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_proveedores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_proveedores']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_proveedores']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_proveedores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=form_pedidos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_pedidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pedidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_pedidos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=form_ingreso_producto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ingreso_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_ingreso_producto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ingreso_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ingreso_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=form_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=grid_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_categorias']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_categorias']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=form_tipo_documento&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_documento']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_documento']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_tipo_documento&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_documento']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tipo_documento']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_28&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_29&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Android_Orange_hor_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Android_Orange" . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Android_Orange" . '_' . hor . '.css'); } ?>" />
<style>
   .scTabText {
   }</style>
<script>
...
<table width="100%" height="67px" class="scMenuHHeader">
        <tr>
                <td width="5px"></td>
        <td width="67px" class="scMenuHHeaderFont">   <IMG SRC="<?php echo $path_imag_cab ?>/sys__NM__bg__NM__logoInversoftTrasparenteIndex.png" BORDER="0"/></td>
               <td class="scMenuHHeaderFont"><span id="lin1_col1"><?php echo "Inversoft" ?></span><br /><span id="lin2_col1"><?php echo "Sistema de Inventario" ?></span></td>
               <td align="right" class="scMenuHHeaderFont"><span  id="lin1_col2"><?php echo $nm_data_fixa ?></span><br /><span id="lin2_col2"><?php echo "Bienvenido : " . $_SESSION['usr_login'] . "" ?></span></td>
        <td width="5px"></td>
    </tr>
</table>
    </td>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_fondo_inicial']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_fondo_inicial'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=blank_fondo_inicial&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
} 
else
{ 
...
<div style="width: 100%; height:20px;" class="scMenuHFooter">
        <span class="scMenuHFooterFont" id="rod_col1"><?php echo "COPYRIGHT � 2019 FERRETERIA JC. " ?></span>
        <span class="scMenuHFooterFont" id="rod_col2"><?php echo "Todos los derechos reservados - ADSI - Sena" ?></span>
</div>    </td>
  </tr>
</table>
</body>
