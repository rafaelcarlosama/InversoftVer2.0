...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_cliente_label" id="hidden_field_label_id_cliente" style="<?php echo $sStyleHidden_id_cliente; ?>"><span id="id_label_id_cliente"><?php echo $this->nm_new_label['id_cliente']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['id_cliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes']['php_cmp_required']['id_cliente'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombre_cliente_line" id="hidden_field_data_nombre_cliente" style="<?php echo $sStyleHidden_nombre_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_cliente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefono_fijo_cliente_label" id="hidden_field_label_telefono_fijo_cliente" style="<?php echo $sStyleHidden_telefono_fijo_cliente; ?>"><span id="id_label_telefono_fijo_cliente"><?php echo $this->nm_new_label['telefono_fijo_cliente']; ?></span></TD>
    <TD class="scFormDataOdd css_telefono_fijo_cliente_line" id="hidden_field_data_telefono_fijo_cliente" style="<?php echo $sStyleHidden_telefono_fijo_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefono_fijo_cliente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_telefono_celular_cliente_label" id="hidden_field_label_telefono_celular_cliente" style="<?php echo $sStyleHidden_telefono_celular_cliente; ?>"><span id="id_label_telefono_celular_cliente"><?php echo $this->nm_new_label['telefono_celular_cliente']; ?></span></TD>
    <TD class="scFormDataOdd css_telefono_celular_cliente_line" id="hidden_field_data_telefono_celular_cliente" style="<?php echo $sStyleHidden_telefono_celular_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefono_celular_cliente_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_direccion_cliente_line" id="hidden_field_data_direccion_cliente" style="<?php echo $sStyleHidden_direccion_cliente; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_cliente_line" style="vertical-align: top;padding: 0px">
