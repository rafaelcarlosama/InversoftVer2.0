      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_form_clientes_mob->contr_->NM_ajax_info['redir']['action']  = $nm_apl_dest;
...
// 
      ...
      if ((isset($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag) && $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag) || (isset($_SESSION['sc_session'][$this->sc_page]['form_clientes']['embutida_call']) && $_SESSION['sc_session'][$this->sc_page]['form_clientes']['embutida_call']) || $NM_run_iframe == 1)
      {
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
$_SESSION['scriptcase']['nmamp'] = array(60, 100, 105, 118, 32, 115, 116, 121, 108, 101, 61, 34, 102, 111, 110, 116, 45, 102, 97, 109, 105, 108, 121, 58, 32, 84, 97, 104, 111, 109, 97, 44, 32, 65, 114, 105, 97, 108, 44, 32, 115, 97, 110, 115, 45, 115, 101, 114, 105, 102, 59, 32, 102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 32, 49, 51, 112, 120, 59, 32, 102, 111, 110, 116, 45, 119, 101, 105, 103, 104, 116, 58, 32, 98, 111, 108, 100, 59, 32, 116, 101, 120, 116, 45, 97, 108, 105, 103, 110, 58, 32, 99, 101, 110, 116, 101, 114, 34, 62, 84, 104, 105, 115, 32, 97, 112, 112, 108, 105, 99, 97, 116, 105, 111, 110, 32, 119, 97, 115, 32, 100, 101, 118, 101, 108, 111, 112, 101, 100, 32, 97, 110, 100, 32, 112, 117, 98, 108, 105, 115, 104, 101, 100, 32, 117, 115, 105, 110, 103, 32, 97, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32, 83, 99, 114, 105, 112, 116, 67, 97, 115, 101, 32, 97, 110, 100, 32, 105, 116, 115, 32, 116, 114, 105, 97, 108, 32, 112, 101, 114, 105, 111, 100, 32, 104, 97, 115, 32, 101, 120, 112, 105, 114, 101, 100, 46, 60, 47, 100, 105, 118, 62);
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['form_clientes_mob']['Gera_log_access'] = true;
      } 
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'inversoft'); 
      } 
      else 
      { 
...
//
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']))
    {
        ...
        if ('ajax_form_clientes_mob_validate_telefono_fijo_cliente' == $_POST['rs'])
        {
            $telefono_fijo_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_clientes_mob_validate_telefono_celular_cliente' == $_POST['rs'])
        {
            $telefono_celular_cliente = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        ...
        if ('ajax_form_clientes_mob_validate_id_usuario' == $_POST['rs'])
        {
        ...
        if ('ajax_form_clientes_mob_submit_form' == $_POST['rs'])
        {
            ...
            $telefono_fijo_cliente = NM_utf8_urldecode($_POST['rsargs'][2]);
            $telefono_celular_cliente = NM_utf8_urldecode($_POST['rsargs'][3]);
    ...
    else
    {
        ...
        elseif ($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "R")
        {
           ...
           $nm_url_saida = str_replace("_fim.php", ".php", $nm_url_saida); 
            ...
            if ($_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['form_clientes_mob']['run_iframe'] != "R" && (!isset($_SESSION['sc_session'][$script_case_init]['form_clientes']['embutida_call']) || !$_SESSION['sc_session'][$script_case_init]['form_clientes']['embutida_call']))
            { 
    ...
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes']) || $_SESSION['scriptcase']['sc_apl_seg']['form_clientes'] != "on")
    { 
...
<?php
    ...
    $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['select_html']['id_usuario'] = "class=\"sc-js-input scFormObjectOdd css_id_usuario_obj\" style=\"\" id=\"id_sc_field_id_usuario\" name=\"id_usuario\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    ...
    sajax_export("ajax_form_clientes_mob_validate_telefono_fijo_cliente");
    sajax_export("ajax_form_clientes_mob_validate_telefono_celular_cliente");
    sajax_export("ajax_form_clientes_mob_validate_direccion_cliente");
    sajax_export("ajax_form_clientes_mob_validate_id_usuario");
...
//
    ...
    function ajax_form_clientes_mob_validate_telefono_fijo_cliente($telefono_fijo_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_telefono_fijo_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
                  'telefono_fijo_cliente' => NM_utf8_urldecode($telefono_fijo_cliente),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_clientes_mob->contr_form_clientes_mob->controle();
        exit;
    } // ajax_validate_telefono_fijo_cliente

    function ajax_form_clientes_mob_validate_telefono_celular_cliente($telefono_celular_cliente, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_telefono_celular_cliente';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
                  'telefono_celular_cliente' => NM_utf8_urldecode($telefono_celular_cliente),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_clientes_mob->contr_form_clientes_mob->controle();
        exit;
    } // ajax_validate_telefono_celular_cliente
    ...
    function ajax_form_clientes_mob_validate_id_usuario($id_usuario, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_opcao         = 'validate_id_usuario';
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_clientes_mob_submit_form($id_cliente, $nombre_cliente, $telefono_fijo_cliente, $telefono_celular_cliente, $direccion_cliente, $id_usuario, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
    ...
    function ajax_form_clientes_mob_navigate_form($id_cliente, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_fast_search, $nmgp_cond_fast_search, $nmgp_arg_fast_search, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_clientes_mob;
        //register_shutdown_function("form_clientes_mob_pack_ajax_response");
        $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_flag          = true;
...
//-----
   ...
   {
      global $inicial_form_clientes_mob;
      $aResp['ajaxAlert'] = array('message' => $inicial_form_clientes_mob->contr_form_clientes_mob->NM_ajax_info['ajaxAlert']['message']);
