...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["inversoft_____grid_pedidos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["inversoft_____grid_pedidos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pedidos'] = array();
   $fecha_janela = false;
