...
//
   ...
   $this->Cmps_ord_def['Fecha_Pedido'] = " desc";
   $this->Cmps_ord_def['Cantidad_Pedido'] = " desc";
   $this->Cmps_ord_def['Valor_Unidad_Pedido'] = " desc";
   ...
   { 
       ...
       $this->valor_unidad_pedido = $Busca_temp['valor_unidad_pedido']; 
       $tmp_pos = strpos($this->valor_unidad_pedido, "##@@");
       if ($tmp_pos !== false && !is_array($this->valor_unidad_pedido))
       {
           $this->valor_unidad_pedido = substr($this->valor_unidad_pedido, 0, $tmp_pos);
       }
       $valor_unidad_pedido_2 = $Busca_temp['valor_unidad_pedido_input_2']; 
       $this->valor_unidad_pedido_2 = $Busca_temp['valor_unidad_pedido_input_2']; 
       ...
       $this->fecha_pedido = $Busca_temp['fecha_pedido']; 
       $tmp_pos = strpos($this->fecha_pedido, "##@@");
       if ($tmp_pos !== false && !is_array($this->fecha_pedido))
       {
           $this->fecha_pedido = substr($this->fecha_pedido, 0, $tmp_pos);
       }
       $fecha_pedido_2 = $Busca_temp['fecha_pedido_input_2']; 
       $this->fecha_pedido_2 = $Busca_temp['fecha_pedido_input_2']; 
       $this->cantidad_pedido = $Busca_temp['cantidad_pedido']; 
       $tmp_pos = strpos($this->cantidad_pedido, "##@@");
       if ($tmp_pos !== false && !is_array($this->cantidad_pedido))
       {
           $this->cantidad_pedido = substr($this->cantidad_pedido, 0, $tmp_pos);
       }
       $cantidad_pedido_2 = $Busca_temp['cantidad_pedido_input_2']; 
       $this->cantidad_pedido_2 = $Busca_temp['cantidad_pedido_input_2']; 
   } 
   else 
   { 
       $this->fecha_pedido_2 = ""; 
...
//----- 
   ...
   { 
       $this->id_pedido = $this->rs_grid->fields[0] ;  
       $this->id_pedido = (string)$this->id_pedido;
       $this->fecha_pedido = $this->rs_grid->fields[1] ;  
       $this->cantidad_pedido = $this->rs_grid->fields[2] ;  
       $this->cantidad_pedido = (string)$this->cantidad_pedido;
       $this->valor_unidad_pedido = $this->rs_grid->fields[3] ;  
...
<?php
       ...
       { 
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_pedidos-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-53fe0bc8\");\r\n");
 ...
 {  
   ...
   $this->css_fecha_pedido_label = $compl_css_emb . "css_fecha_pedido_label";
   $this->css_fecha_pedido_grid_line = $compl_css_emb . "css_fecha_pedido_grid_line";
   $this->css_cantidad_pedido_label = $compl_css_emb . "css_cantidad_pedido_label";
   $this->css_cantidad_pedido_grid_line = $compl_css_emb . "css_cantidad_pedido_grid_line";
   $this->css_valor_unidad_pedido_label = $compl_css_emb . "css_valor_unidad_pedido_label";
   $this->css_valor_unidad_pedido_grid_line = $compl_css_emb . "css_valor_unidad_pedido_grid_line";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_id_cliente_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 function NM_label_id_pedido()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'Id_Pedido')
      {
 ...
 function NM_label_fecha_pedido()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['fecha_pedido'])) ? $this->New_label['fecha_pedido'] : "Fecha Pedido"; 
   if (!isset($this->NM_cmp_hidden['fecha_pedido']) || $this->NM_cmp_hidden['fecha_pedido'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_fecha_pedido_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_fecha_pedido_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'Fecha_Pedido')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Fecha_Pedido')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_cantidad_pedido()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cantidad_pedido'])) ? $this->New_label['cantidad_pedido'] : "Cantidad Pedido"; 
   if (!isset($this->NM_cmp_hidden['cantidad_pedido']) || $this->NM_cmp_hidden['cantidad_pedido'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_cantidad_pedido_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cantidad_pedido_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'Cantidad_Pedido')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Cantidad_Pedido')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_valor_unidad_pedido()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['valor_unidad_pedido'])) ? $this->New_label['valor_unidad_pedido'] : "Valor Unidad Pedido"; 
   if (!isset($this->NM_cmp_hidden['valor_unidad_pedido']) || $this->NM_cmp_hidden['valor_unidad_pedido'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_valor_unidad_pedido_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_valor_unidad_pedido_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'Valor_Unidad_Pedido')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Valor_Unidad_Pedido')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_id_cliente()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_cmp'] == 'Id_Cliente')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
// 
   $SC_Label = (isset($this->New_label['id_pedido'])) ? $this->New_label['id_pedido'] : "Id Pedido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['id_pedido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha_pedido'])) ? $this->New_label['fecha_pedido'] : "Fecha Pedido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['fecha_pedido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cantidad_pedido'])) ? $this->New_label['cantidad_pedido'] : "Cantidad Pedido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['cantidad_pedido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valor_unidad_pedido'])) ? $this->New_label['valor_unidad_pedido'] : "Valor Unidad Pedido"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['valor_unidad_pedido'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['labels']['id_cliente'] = $SC_Label; 
...
// 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_id_cliente_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['mostra_edit'] != "N"){ 
              ...
              if (isset($this->Ini->sc_lig_md5["form_pedidos"]) && $this->Ini->sc_lig_md5["form_pedidos"] == "S")
              {
                  $Parms_Edt  = "id_pedido?#?" . str_replace('"', "@aspasd@", $this->id_pedido) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              ...
              {
                  $Md5_Edt  = "id_pedido?#?" . str_replace('"', "@aspasd@", $this->id_pedido) . "?@?NM_btn_insert?#?S?@?NM_btn_update?#?S?@?NM_btn_delete?#?S?@?NM_btn_navega?#?N?@?nmgp_opcao?#?igual?@?";
              }
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_pedidos . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_pedidos', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_pedidos . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_pedidos', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->id_pedido . "?@?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_pedidos@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
 ...
 function NM_grid_fecha_pedido()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['fecha_pedido']) || $this->NM_cmp_hidden['fecha_pedido'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->fecha_pedido)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_fecha_pedido_grid_line . "\"  style=\"" . $this->Css_Cmp['css_fecha_pedido_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fecha_pedido_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_cantidad_pedido()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['cantidad_pedido']) || $this->NM_cmp_hidden['cantidad_pedido'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->cantidad_pedido)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_cantidad_pedido_grid_line . "\"  style=\"" . $this->Css_Cmp['css_cantidad_pedido_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_cantidad_pedido_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_valor_unidad_pedido()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['valor_unidad_pedido']) || $this->NM_cmp_hidden['valor_unidad_pedido'] != "off") { 
          $conteudo = NM_encode_input(sc_strip_script($this->valor_unidad_pedido)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_valor_unidad_pedido_grid_line . "\"  style=\"" . $this->Css_Cmp['css_valor_unidad_pedido_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_valor_unidad_pedido_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['new'] == "on" && $this->nmgp_botoes['insert'] == "on" && !$this->grid_emb_form)
        {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bnovo", "nm_gp_submit1('" .  $this->Ini->link_form_pedidos . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_pedidos'); return false;", "nm_gp_submit1('" .  $this->Ini->link_form_pedidos . "', '$this->nm_location', '$Md5_Lig', '_self', 'form_pedidos'); return false;", "sc_b_new_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
         $NM_btn = true;
        }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_pedidos';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_pedidos/grid_pedidos_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
