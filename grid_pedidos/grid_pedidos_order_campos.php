...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id_pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id_pedido"] : "Id Pedido";
   $tab_ger_campos['fecha_pedido'] = "on";
   $tab_def_campos['fecha_pedido'] = "Fecha_Pedido";
   $tab_converte["Fecha_Pedido"]   = "fecha_pedido";
   $tab_labels["fecha_pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["fecha_pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["fecha_pedido"] : "Fecha Pedido";
   $tab_ger_campos['cantidad_pedido'] = "on";
   $tab_def_campos['cantidad_pedido'] = "Cantidad_Pedido";
   $tab_converte["Cantidad_Pedido"]   = "cantidad_pedido";
   $tab_labels["cantidad_pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["cantidad_pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["cantidad_pedido"] : "Cantidad Pedido";
   $tab_ger_campos['valor_unidad_pedido'] = "on";
   $tab_def_campos['valor_unidad_pedido'] = "Valor_Unidad_Pedido";
   $tab_converte["Valor_Unidad_Pedido"]   = "valor_unidad_pedido";
   $tab_labels["valor_unidad_pedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["valor_unidad_pedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["valor_unidad_pedido"] : "Valor Unidad Pedido";
   $tab_ger_campos['id_cliente'] = "on";
   $tab_def_campos['id_cliente'] = "Id_Cliente";
   $tab_converte["Id_Cliente"]   = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos']['labels']["id_cliente"] : "Id Cliente";
