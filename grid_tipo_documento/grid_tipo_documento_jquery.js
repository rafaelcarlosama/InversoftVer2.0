...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_tipo_documento').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_tipo_documento').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_tipo_documento').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_tipo_documento').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_tipo_documento').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_tipo_documento').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_tipo_documento').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_tipo_documento').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_tipo_documento').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_tipo_documento').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_tipo_documento').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_tipo_documento').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
