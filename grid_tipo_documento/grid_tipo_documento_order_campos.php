<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_tipo_documento_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_tipo_documento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['id_tipodoc'] = "Id_Tipodoc";
   $tab_converte["Id_Tipodoc"]   = "id_tipodoc";
   $tab_labels["id_tipodoc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['labels']["id_tipodoc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['labels']["id_tipodoc"] : "Id Tipodoc";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "Descripcion";
   $tab_converte["Descripcion"]   = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['labels']["descripcion"] : "Descripcion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_tipo_documento_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tipo_documento']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
