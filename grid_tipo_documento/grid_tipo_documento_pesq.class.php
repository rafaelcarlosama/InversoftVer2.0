...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tipo_documento</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_tipodoc'])) ? $this->New_label['id_tipodoc'] : "Id Tipodoc"; ?></TD>
     <TD class="scFilterFieldOdd"> 
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_tipodoc" <?php echo $str_hide_id_tipodoc?> valign="top">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_tipodoc" name="id_tipodoc_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
       ...
       <TR valign="top">
        <TD id="id_vis_id_tipodoc"  <?php echo $str_display_id_tipodoc; ?> class="scFilterFieldFontOdd">
