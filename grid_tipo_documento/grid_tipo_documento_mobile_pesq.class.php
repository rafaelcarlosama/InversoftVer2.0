...
class grid_tipo_documento_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_tipo_documento_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tipo_documento_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tipo_documento_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tipo_documento_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_tipodoc')
      {
          $id_tipodoc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_tipodoc($id_tipodoc);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_tipodoc($id_tipodoc)
   {
      $id_tipodoc = substr($this->Db->qstr($id_tipodoc), 1, -1);
            $id_tipodoc_look = substr($this->Db->qstr($id_tipodoc), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Tipodoc from " . $this->Ini->nm_tabela . " where   CAST (Id_Tipodoc AS TEXT)  like '%" . $id_tipodoc . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Tipodoc from " . $this->Ini->nm_tabela . " where  Id_Tipodoc like '%" . $id_tipodoc . "%'"; 
      }
   ...
   function lookup_ajax_descripcion($descripcion)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Descripcion from " . $this->Ini->nm_tabela . " where  Descripcion like '%" . $descripcion . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_tipodoc";$Nm_numeric[] = "id_tipodoc";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tipo_documento/grid_tipo_documento_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tipo_documento_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tipo_documento_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_tipodoc_cond#NMF#' + search_get_sel_txt('SC_id_tipodoc_cond') + '@NMF@';
  str_out += 'SC_id_tipodoc#NMF#' + search_get_text('SC_id_tipodoc') + '@NMF@';
  str_out += 'id_ac_id_tipodoc#NMF#' + search_get_text('id_ac_id_tipodoc') + '@NMF@';
  str_out += 'SC_id_tipodoc_input_2#NMF#' + search_get_text('SC_id_tipodoc_input_2') + '@NMF@';
   ...
   $("#id_ac_id_tipodoc").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_tipodoc",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_tipodoc").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_tipodoc").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - tipo_documento</span></td>
...
<?php
   ...
   {
      global 
             $id_tipodoc_cond, $id_tipodoc, $id_tipodoc_input_2, $id_tipodoc_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_tipodoc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc']; 
          $id_tipodoc_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc_input_2']; 
          $id_tipodoc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_tipodoc_cond) || empty($id_tipodoc_cond))
      {
         $id_tipodoc_cond = "gt";
      }
      ...
      $str_hide_id_tipodoc = (in_array($id_tipodoc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descripcion = (in_array($descripcion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_tipodoc = ('bw' == $id_tipodoc_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_tipodoc) || $id_tipodoc == "")
      {
          $id_tipodoc = "";
      }
      if (isset($id_tipodoc) && !empty($id_tipodoc))
      {
         $tmp_pos = strpos($id_tipodoc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_tipodoc = substr($id_tipodoc, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_tipo_documento_help.txt"))
   {
...
?>
 ...
 $nmgp_tab_label .= "id_tipodoc?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectOdd" id="SC_id_tipodoc_cond" name="id_tipodoc_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_tipodoc'), this, 'id_tipodoc')">
       <OPTION value="gt" <?php if ("gt" == $id_tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_tipodoc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_id_tipodoc"  <?php echo $str_hide_id_tipodoc?>><?php
      $id_tipodoc_look = substr($this->Db->qstr($id_tipodoc), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_tipodoc))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Tipodoc from " . $this->Ini->nm_tabela . " where Id_Tipodoc = $id_tipodoc_look"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Tipodoc from " . $this->Ini->nm_tabela . " where Id_Tipodoc = $id_tipodoc_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_tipodoc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_tipodoc];
      }
      else
      {
          $sAutocompValue = $id_tipodoc;
      }
?>
<INPUT  type="text" id="SC_id_tipodoc" name="id_tipodoc" value="<?php echo NM_encode_input($id_tipodoc) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_tipodoc" name="id_tipodoc_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_tipodoc"  <?php echo $str_display_id_tipodoc; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_tipodoc_input_2" name="id_tipodoc_input_2" value="<?php echo NM_encode_input($id_tipodoc_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Descripcion from " . $this->Ini->nm_tabela . " where Descripcion = '$descripcion_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_descripcion" name="descripcion" value="<?php echo NM_encode_input($descripcion) ?>" size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descripcion" name="descripcion_autocomp" size="25" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tipo_documento']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tipo_documento']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_tipodoc'), document.F1.id_tipodoc_cond, 'id_tipodoc');
   document.F1.id_tipodoc.value = "";
   document.F1.id_tipodoc_autocomp.value = "";
   document.F1.id_tipodoc_input_2.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "inversoft/grid_tipo_documento";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_tipodoc_cond'] = 'cond';
      $tp_fields['SC_id_tipodoc'] = 'text_aut';
      $tp_fields['id_ac_id_tipodoc'] = 'text_aut';
      $tp_fields['SC_id_tipodoc_input_2'] = 'text';
   ...
   {
      global $id_tipodoc_cond, $id_tipodoc, $id_tipodoc_input_2, $id_tipodoc_autocomp,
             $descripcion_cond, $descripcion, $descripcion_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_tipodoc_autocomp) && empty($id_tipodoc))
      {
          $id_tipodoc = $id_tipodoc_autocomp;
      }
      if (!empty($descripcion_autocomp) && empty($descripcion))
      {
          $descripcion = $descripcion_autocomp;
      }
      $id_tipodoc_cond_salva = $id_tipodoc_cond; 
      if (!isset($id_tipodoc_input_2) || $id_tipodoc_input_2 == "")
      {
          $id_tipodoc_input_2 = $id_tipodoc;
      }
      ...
      if ($id_tipodoc_cond != "in")
      {
          nm_limpa_numero($id_tipodoc, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_tipodoc);
          ...
          $id_tipodoc = implode(",", $Nm_sc_valores);
      }
      if ($id_tipodoc_cond != "in")
      {
          nm_limpa_numero($id_tipodoc_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc'] = $id_tipodoc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc_input_2'] = $id_tipodoc_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['id_tipodoc_cond'] = $id_tipodoc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_tipodoc_cond != "in" && $id_tipodoc_cond != "bw" && !empty($id_tipodoc) && !is_numeric($id_tipodoc))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Tipodoc";
      }
      if ($id_tipodoc_cond == "bw" && ((!empty($id_tipodoc) && !is_numeric($id_tipodoc)) || (!empty($id_tipodoc_input_2) && !is_numeric($id_tipodoc_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Tipodoc";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_tipodoc'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_tipodoc'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_tipodoc'] = $id_tipodoc;
      }
      $Conteudo = $id_tipodoc_input_2;
      if (strtoupper($id_tipodoc_cond) != "II" && strtoupper($id_tipodoc_cond) != "QP" && strtoupper($id_tipodoc_cond) != "NP" && strtoupper($id_tipodoc_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_tipodoc_input_2'] = $Conteudo;
      $descripcion_look = substr($this->Db->qstr($descripcion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Descripcion from " . $this->Ini->nm_tabela . " where Descripcion = '$descripcion_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (isset($id_tipodoc) || $id_tipodoc_cond == "nu" || $id_tipodoc_cond == "nn" || $id_tipodoc_cond == "ep" || $id_tipodoc_cond == "ne")
      {
         $this->monta_condicao("Id_Tipodoc", $id_tipodoc_cond, $id_tipodoc, $id_tipodoc_input_2, "id_tipodoc");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tipo_documento']['where_pesq_ant'] = $this->comando . $this->comando_fim;
