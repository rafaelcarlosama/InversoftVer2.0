...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_usuario_label" id="hidden_field_label_id_usuario" style="<?php echo $sStyleHidden_id_usuario; ?>"><span id="id_label_id_usuario"><?php echo $this->nm_new_label['id_usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['id_usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['id_usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombre_usuario_label" id="hidden_field_label_nombre_usuario" style="<?php echo $sStyleHidden_nombre_usuario; ?>"><span id="id_label_nombre_usuario"><?php echo $this->nm_new_label['nombre_usuario']; ?></span></TD>
    <TD class="scFormDataOdd css_nombre_usuario_line" id="hidden_field_data_nombre_usuario" style="<?php echo $sStyleHidden_nombre_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_email_usuario_label" id="hidden_field_label_email_usuario" style="<?php echo $sStyleHidden_email_usuario; ?>"><span id="id_label_email_usuario"><?php echo $this->nm_new_label['email_usuario']; ?></span></TD>
    <TD class="scFormDataOdd css_email_usuario_line" id="hidden_field_data_email_usuario" style="<?php echo $sStyleHidden_email_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_password_usuario_label" id="hidden_field_label_password_usuario" style="<?php echo $sStyleHidden_password_usuario; ?>"><span id="id_label_password_usuario"><?php echo $this->nm_new_label['password_usuario']; ?></span></TD>
    <TD class="scFormDataOdd css_password_usuario_line" id="hidden_field_data_password_usuario" style="<?php echo $sStyleHidden_password_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_password_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estado_usuario_label" id="hidden_field_label_estado_usuario" style="<?php echo $sStyleHidden_estado_usuario; ?>"><span id="id_label_estado_usuario"><?php echo $this->nm_new_label['estado_usuario']; ?></span></TD>
    <TD class="scFormDataOdd css_estado_usuario_line" id="hidden_field_data_estado_usuario" style="<?php echo $sStyleHidden_estado_usuario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_usuario_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_perfil_line" id="hidden_field_data_id_perfil" style="<?php echo $sStyleHidden_id_perfil; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_perfil_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_tipodoc_line" id="hidden_field_data_id_tipodoc" style="<?php echo $sStyleHidden_id_tipodoc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tipodoc_line" style="vertical-align: top;padding: 0px">
