...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_categorias_mob_validate_id_categoria()
  {
    var nomeCampo_id_categoria = "id_categoria";
    var var_id_categoria = scAjaxGetFieldHidden(nomeCampo_id_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_id_categoria(var_id_categoria, var_script_case_init, do_ajax_form_categorias_mob_validate_id_categoria_cb);
  } // do_ajax_form_categorias_mob_validate_id_categoria

  function do_ajax_form_categorias_mob_validate_id_categoria_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_id_categoria_cb

  // ---------- Validate nombre_categoria
  function do_ajax_form_categorias_mob_validate_nombre_categoria()
  {
    var nomeCampo_nombre_categoria = "nombre_categoria";
    var var_nombre_categoria = scAjaxGetFieldText(nomeCampo_nombre_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_nombre_categoria(var_nombre_categoria, var_script_case_init, do_ajax_form_categorias_mob_validate_nombre_categoria_cb);
  } // do_ajax_form_categorias_mob_validate_nombre_categoria

  function do_ajax_form_categorias_mob_validate_nombre_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_categoria";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_nombre_categoria_cb
  // ---------- Form
  function do_ajax_form_categorias_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_id_categoria = scAjaxGetFieldHidden("id_categoria");
    var var_nombre_categoria = scAjaxGetFieldText("nombre_categoria");
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_mob_submit_form(var_id_categoria, var_nombre_categoria, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categorias_mob_submit_form_cb);
  ...
  function do_ajax_form_categorias_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_categoria");
      scLigEditLookupCall();
    }
  ...
  function do_ajax_form_categorias_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("id_categoria");
    scAjaxHideErrorDisplay("nombre_categoria");
    var var_id_categoria = document.F2.id_categoria.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_mob_navigate_form(var_id_categoria, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_mob_navigate_form_cb);
  ...
  function do_ajax_form_categorias_mob_navigate_form_cb(sResp)
  {
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_categorias_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_categoria.value = scAjaxGetKeyValue("id_categoria");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
?>
  ...
  function sc_hide_form_categorias_mob_form()
  {
  ...
  ajax_field_list[0] = "id_categoria";
  ajax_field_list[1] = "nombre_categoria";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_categoria": {"label": "Id Categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_categoria": {"label": "Nombre Categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nombre_categoria": new Array()
  };
  ajax_field_mult["id_categoria"][1] = "id_categoria";
  ajax_field_mult["nombre_categoria"][1] = "nombre_categoria";

  var ajax_field_id = {
    "id_categoria": new Array("hidden_field_label_id_categoria", "hidden_field_data_id_categoria"),
    "nombre_categoria": new Array("hidden_field_label_nombre_categoria", "hidden_field_data_nombre_categoria")
  };

  var ajax_read_only = {
    "id_categoria": "on",
    "nombre_categoria": "off"
  };
