...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_categorias_validate_id_categoria()
  {
    var nomeCampo_id_categoria = "id_categoria";
    var var_id_categoria = scAjaxGetFieldHidden(nomeCampo_id_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_id_categoria(var_id_categoria, var_script_case_init, do_ajax_form_categorias_validate_id_categoria_cb);
  } // do_ajax_form_categorias_validate_id_categoria

  function do_ajax_form_categorias_validate_id_categoria_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_id_categoria_cb

  // ---------- Validate nombre_categoria
  function do_ajax_form_categorias_validate_nombre_categoria()
  {
    var nomeCampo_nombre_categoria = "nombre_categoria";
    var var_nombre_categoria = scAjaxGetFieldText(nomeCampo_nombre_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_nombre_categoria(var_nombre_categoria, var_script_case_init, do_ajax_form_categorias_validate_nombre_categoria_cb);
  } // do_ajax_form_categorias_validate_nombre_categoria

  function do_ajax_form_categorias_validate_nombre_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_nombre_categoria_cb
  // ---------- Form
  function do_ajax_form_categorias_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_submit_form(var_id_categoria, var_nombre_categoria, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categorias_submit_form_cb);
  ...
  function do_ajax_form_categorias_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_navigate_form(var_id_categoria, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_navigate_form_cb);
...
?>
  ...
  function sc_hide_form_categorias_form()
  {
