  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_perfiles_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_perfil
  function do_ajax_form_perfiles_mob_validate_id_perfil()
  {
    var nomeCampo_id_perfil = "id_perfil";
    var var_id_perfil = scAjaxGetFieldHidden(nomeCampo_id_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_perfiles_mob_validate_id_perfil(var_id_perfil, var_script_case_init, do_ajax_form_perfiles_mob_validate_id_perfil_cb);
  } // do_ajax_form_perfiles_mob_validate_id_perfil

  function do_ajax_form_perfiles_mob_validate_id_perfil_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_perfiles_mob_validate_id_perfil_cb

  // ---------- Validate nombre_perfil
  function do_ajax_form_perfiles_mob_validate_nombre_perfil()
  {
    var nomeCampo_nombre_perfil = "nombre_perfil";
    var var_nombre_perfil = scAjaxGetFieldText(nomeCampo_nombre_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_perfiles_mob_validate_nombre_perfil(var_nombre_perfil, var_script_case_init, do_ajax_form_perfiles_mob_validate_nombre_perfil_cb);
  } // do_ajax_form_perfiles_mob_validate_nombre_perfil

  function do_ajax_form_perfiles_mob_validate_nombre_perfil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_perfil";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_perfiles_mob_validate_nombre_perfil_cb
  // ---------- Form
  function do_ajax_form_perfiles_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_perfiles_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_perfil = scAjaxGetFieldHidden("id_perfil");
    var var_nombre_perfil = scAjaxGetFieldText("nombre_perfil");
    ...
    scAjaxProcOn();
    x_ajax_form_perfiles_mob_submit_form(var_id_perfil, var_nombre_perfil, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_perfiles_mob_submit_form_cb);
  } // do_ajax_form_perfiles_mob_submit_form

  function do_ajax_form_perfiles_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("nombre_perfil");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_perfiles_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_perfiles_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_perfil");
    scAjaxHideErrorDisplay("nombre_perfil");
    var var_id_perfil = document.F2.id_perfil.value;
    ...
    scAjaxProcOn();
    x_ajax_form_perfiles_mob_navigate_form(var_id_perfil, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_perfiles_mob_navigate_form_cb);
  } // do_ajax_form_perfiles_mob_navigate_form

  function do_ajax_form_perfiles_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_perfiles_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_perfil.value = scAjaxGetKeyValue("id_perfil");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_perfiles_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_perfiles_mob_navigate_form_cb
  function sc_hide_form_perfiles_mob_form()
  {
  ...
  ajax_field_list[0] = "id_perfil";
  ajax_field_list[1] = "nombre_perfil";
  ...
  var ajax_error_list = {
    ...
    "nombre_perfil": {"label": "Nombre Perfil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_perfil": new Array(),
    "nombre_perfil": new Array()
  };
  ajax_field_mult["id_perfil"][1] = "id_perfil";
  ajax_field_mult["nombre_perfil"][1] = "nombre_perfil";

  var ajax_field_id = {
    "id_perfil": new Array("hidden_field_label_id_perfil", "hidden_field_data_id_perfil"),
    "nombre_perfil": new Array("hidden_field_label_nombre_perfil", "hidden_field_data_nombre_perfil")
  };
