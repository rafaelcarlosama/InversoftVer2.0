  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_perfiles" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_perfil
  function do_ajax_form_perfiles_validate_id_perfil()
  {
    var nomeCampo_id_perfil = "id_perfil";
    var var_id_perfil = scAjaxGetFieldHidden(nomeCampo_id_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_perfiles_validate_id_perfil(var_id_perfil, var_script_case_init, do_ajax_form_perfiles_validate_id_perfil_cb);
  } // do_ajax_form_perfiles_validate_id_perfil

  function do_ajax_form_perfiles_validate_id_perfil_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_perfiles_validate_id_perfil_cb

  // ---------- Validate nombre_perfil
  function do_ajax_form_perfiles_validate_nombre_perfil()
  {
    var nomeCampo_nombre_perfil = "nombre_perfil";
    var var_nombre_perfil = scAjaxGetFieldText(nomeCampo_nombre_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_perfiles_validate_nombre_perfil(var_nombre_perfil, var_script_case_init, do_ajax_form_perfiles_validate_nombre_perfil_cb);
  } // do_ajax_form_perfiles_validate_nombre_perfil

  function do_ajax_form_perfiles_validate_nombre_perfil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_perfiles_validate_nombre_perfil_cb
  // ---------- Form
  function do_ajax_form_perfiles_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_perfiles_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_perfiles_submit_form(var_id_perfil, var_nombre_perfil, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_perfiles_submit_form_cb);
  } // do_ajax_form_perfiles_submit_form

  function do_ajax_form_perfiles_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_perfiles_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_perfiles_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_perfiles_navigate_form(var_id_perfil, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_perfiles_navigate_form_cb);
  } // do_ajax_form_perfiles_navigate_form

  function do_ajax_form_perfiles_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_perfiles_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_perfiles_navigate_form_cb
  function sc_hide_form_perfiles_form()
  {
