...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["id_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["id_producto"] : "Id Producto";
   $tab_ger_campos['nombre_producto'] = "on";
   $tab_def_campos['nombre_producto'] = "Nombre_Producto";
   $tab_converte["Nombre_Producto"]   = "nombre_producto";
   $tab_labels["nombre_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["nombre_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["nombre_producto"] : "Nombre Producto";
   $tab_ger_campos['referencia_producto'] = "on";
   $tab_def_campos['referencia_producto'] = "Referencia_Producto";
   $tab_converte["Referencia_Producto"]   = "referencia_producto";
   $tab_labels["referencia_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["referencia_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["referencia_producto"] : "Referencia Producto";
   $tab_ger_campos['marca_producto'] = "on";
   $tab_def_campos['marca_producto'] = "Marca_Producto";
   $tab_converte["Marca_Producto"]   = "marca_producto";
   $tab_labels["marca_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["marca_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["marca_producto"] : "Marca Producto";
   $tab_ger_campos['descripcion_producto'] = "on";
   $tab_def_campos['descripcion_producto'] = "Descripcion_Producto";
   $tab_converte["Descripcion_Producto"]   = "descripcion_producto";
   $tab_labels["descripcion_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["descripcion_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["descripcion_producto"] : "Descripcion Producto";
   $tab_ger_campos['id_categoria'] = "on";
   $tab_def_campos['id_categoria'] = "Id_Categoria";
   $tab_converte["Id_Categoria"]   = "id_categoria";
   $tab_labels["id_categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["id_categoria"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos']['labels']["id_categoria"] : "Id Categoria";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_productos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_productos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
