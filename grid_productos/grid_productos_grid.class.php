...
//
   ...
   $this->Cmps_ord_def['Nombre_Producto'] = " asc";
   $this->Cmps_ord_def['Referencia_Producto'] = " asc";
   $this->Cmps_ord_def['Marca_Producto'] = " asc";
   $this->Cmps_ord_def['Descripcion_Producto'] = " asc";
   ...
   { 
       ...
       $this->marca_producto = $Busca_temp['marca_producto']; 
       $tmp_pos = strpos($this->marca_producto, "##@@");
       if ($tmp_pos !== false && !is_array($this->marca_producto))
       {
           $this->marca_producto = substr($this->marca_producto, 0, $tmp_pos);
       }
       ...
       $this->nombre_producto = $Busca_temp['nombre_producto']; 
       $tmp_pos = strpos($this->nombre_producto, "##@@");
       if ($tmp_pos !== false && !is_array($this->nombre_producto))
       {
           $this->nombre_producto = substr($this->nombre_producto, 0, $tmp_pos);
       }
       $this->referencia_producto = $Busca_temp['referencia_producto']; 
       $tmp_pos = strpos($this->referencia_producto, "##@@");
       if ($tmp_pos !== false && !is_array($this->referencia_producto))
       {
           $this->referencia_producto = substr($this->referencia_producto, 0, $tmp_pos);
       }
   } 
...
//
   ...
   { 
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_quebra'][$nmgp_ordem])) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] = "inicio" ;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_grid'] = ""; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_quebra'][$nmgp_ordem] == "asc") 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_quebra'][$nmgp_ordem] = "desc"; 
           }   
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_quebra'][$nmgp_ordem] = "asc"; 
           }   
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] = $nmgp_ordem;  
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_quebra'][$nmgp_ordem]);  
       }   
       else   
       { 
...
//----- 
   ...
   { 
       $nmgp_select = "SELECT Id_Producto, Nombre_Producto, Referencia_Producto, Marca_Producto, Descripcion_Producto, Id_Categoria from " . $this->Ini->nm_tabela; 
   } 
   ...
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] == "pdf" || isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['paginacao']))
   {
   ...
   { 
       ...
       $this->nombre_producto = $this->rs_grid->fields[1] ;  
       $this->referencia_producto = $this->rs_grid->fields[2] ;  
       $this->marca_producto = $this->rs_grid->fields[3] ;  
       $this->descripcion_producto = $this->rs_grid->fields[4] ;  
       $this->id_categoria = $this->rs_grid->fields[5] ;  
...
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'])
   { 
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - productos :: PDF</TITLE>
...
<?php
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - productos</TITLE>\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ajax_nav'])
       { 
           ...
           $nm_saida->saida("   gridHeaders = $(\".sc-ui-grid-header-row-grid_productos-1\");\r\n");
           ...
           $nm_saida->saida("   tableOriginal = $(\"#sc-ui-grid-body-08dce820\");\r\n");
 ...
 {  
   ...
   $this->css_nombre_producto_label = $compl_css_emb . "css_nombre_producto_label";
   $this->css_nombre_producto_grid_line = $compl_css_emb . "css_nombre_producto_grid_line";
   $this->css_referencia_producto_label = $compl_css_emb . "css_referencia_producto_label";
   $this->css_referencia_producto_grid_line = $compl_css_emb . "css_referencia_producto_grid_line";
   $this->css_marca_producto_label = $compl_css_emb . "css_marca_producto_label";
   $this->css_marca_producto_grid_line = $compl_css_emb . "css_marca_producto_grid_line";
   $this->css_descripcion_producto_label = $compl_css_emb . "css_descripcion_producto_label";
   $this->css_descripcion_producto_grid_line = $compl_css_emb . "css_descripcion_producto_grid_line";
...
//----- 
 function cabecalho()
 {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - productos</span></td>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_id_categoria_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 function NM_label_id_producto()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Id_Producto')
      {
 ...
 function NM_label_nombre_producto()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['nombre_producto'])) ? $this->New_label['nombre_producto'] : "Nombre Producto"; 
   if (!isset($this->NM_cmp_hidden['nombre_producto']) || $this->NM_cmp_hidden['nombre_producto'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_nombre_producto_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_nombre_producto_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Nombre_Producto')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Nombre_Producto')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_referencia_producto()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['referencia_producto'])) ? $this->New_label['referencia_producto'] : "Referencia Producto"; 
   if (!isset($this->NM_cmp_hidden['referencia_producto']) || $this->NM_cmp_hidden['referencia_producto'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_referencia_producto_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_referencia_producto_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Referencia_Producto')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Referencia_Producto')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_marca_producto()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['marca_producto'])) ? $this->New_label['marca_producto'] : "Marca Producto"; 
   if (!isset($this->NM_cmp_hidden['marca_producto']) || $this->NM_cmp_hidden['marca_producto'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_marca_producto_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_marca_producto_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Marca_Producto')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Marca_Producto')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_descripcion_producto()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['descripcion_producto'])) ? $this->New_label['descripcion_producto'] : "Descripcion Producto"; 
   if (!isset($this->NM_cmp_hidden['descripcion_producto']) || $this->NM_cmp_hidden['descripcion_producto'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_descripcion_producto_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_descripcion_producto_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Descripcion_Producto')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('Descripcion_Producto')\" class=\"" . $this->css_scGridLabelLink . "\">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_id_categoria()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_cmp'] == 'Id_Categoria')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
// 
   $SC_Label = (isset($this->New_label['id_producto'])) ? $this->New_label['id_producto'] : "Id Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['id_producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nombre_producto'])) ? $this->New_label['nombre_producto'] : "Nombre Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['nombre_producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['referencia_producto'])) ? $this->New_label['referencia_producto'] : "Referencia Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['referencia_producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['marca_producto'])) ? $this->New_label['marca_producto'] : "Marca Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['marca_producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['descripcion_producto'])) ? $this->New_label['descripcion_producto'] : "Descripcion Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['descripcion_producto'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['id_categoria'])) ? $this->New_label['id_categoria'] : "Id Categoria"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['labels']['id_categoria'] = $SC_Label; 
...
// 
   ...
   {  
          ...
          //---------- Gauge ----------
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_id_categoria_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['mostra_edit'] != "N"){ 
              ...
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "nm_gp_submit4('" .  $this->Ini->link_form_productos . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_productos', '" . $this->SC_ancora . "')", "nm_gp_submit4('" .  $this->Ini->link_form_productos . "', '$this->nm_location',  '$Md5_Edt' , '_self', '', 'form_productos', '" . $this->SC_ancora . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
 ...
 function NM_grid_nombre_producto()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['nombre_producto']) || $this->NM_cmp_hidden['nombre_producto'] != "off") { 
          $conteudo = sc_strip_script($this->nombre_producto); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_nombre_producto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nombre_producto_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_nombre_producto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_referencia_producto()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['referencia_producto']) || $this->NM_cmp_hidden['referencia_producto'] != "off") { 
          $conteudo = sc_strip_script($this->referencia_producto); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_referencia_producto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_referencia_producto_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_referencia_producto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_marca_producto()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['marca_producto']) || $this->NM_cmp_hidden['marca_producto'] != "off") { 
          $conteudo = sc_strip_script($this->marca_producto); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_marca_producto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_marca_producto_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_marca_producto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_descripcion_producto()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['descripcion_producto']) || $this->NM_cmp_hidden['descripcion_producto'] != "off") { 
          $conteudo = sc_strip_script($this->descripcion_producto); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_descripcion_producto_grid_line . "\"  style=\"" . $this->Css_Cmp['css_descripcion_producto_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_descripcion_producto_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_geral_top() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_productos/grid_productos_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&language=es&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_productos/grid_productos_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao_print'] != "print") 
      {
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['paginacao']))
          {
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['nav']) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['paginacao']))
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "nm_gp_submit_rec('" . $this->Rec_fim . "')", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_liga']['nav']))
          {
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_productos/grid_productos_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_productos/grid_productos_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=print&tp_print=' + tp + '&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
