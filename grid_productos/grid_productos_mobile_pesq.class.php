...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_producto";$Nm_numeric[] = "id_categoria";$Nm_numeric[] = "id_usuario";$Nm_numeric[] = "id_producto";$Nm_numeric[] = "id_categoria";$Nm_numeric[] = "id_usuario";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_marca_producto"  <?php echo $str_hide_marca_producto?>><?php
      $marca_producto_look = substr($this->Db->qstr($marca_producto), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_producto"  <?php echo $str_hide_nombre_producto?>><?php
      $nombre_producto_look = substr($this->Db->qstr($nombre_producto), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_referencia_producto"  <?php echo $str_hide_referencia_producto?>><?php
      $referencia_producto_look = substr($this->Db->qstr($referencia_producto), 1, -1); 
      $nmgp_def_dados = array(); 
