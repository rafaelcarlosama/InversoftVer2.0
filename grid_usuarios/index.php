...
$_SESSION['scriptcase']['nmamp'] = array(60, 100, 105, 118, 32, 115, 116, 121, 108, 101, 61, 34, 102, 111, 110, 116, 45, 102, 97, 109, 105, 108, 121, 58, 32, 84, 97, 104, 111, 109, 97, 44, 32, 65, 114, 105, 97, 108, 44, 32, 115, 97, 110, 115, 45, 115, 101, 114, 105, 102, 59, 32, 102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 32, 49, 51, 112, 120, 59, 32, 102, 111, 110, 116, 45, 119, 101, 105, 103, 104, 116, 58, 32, 98, 111, 108, 100, 59, 32, 116, 101, 120, 116, 45, 97, 108, 105, 103, 110, 58, 32, 99, 101, 110, 116, 101, 114, 34, 62, 84, 104, 105, 115, 32, 97, 112, 112, 108, 105, 99, 97, 116, 105, 111, 110, 32, 119, 97, 115, 32, 100, 101, 118, 101, 108, 111, 112, 101, 100, 32, 97, 110, 100, 32, 112, 117, 98, 108, 105, 115, 104, 101, 100, 32, 117, 115, 105, 110, 103, 32, 97, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32, 83, 99, 114, 105, 112, 116, 67, 97, 115, 101, 32, 97, 110, 100, 32, 105, 116, 115, 32, 116, 114, 105, 97, 108, 32, 112, 101, 114, 105, 111, 100, 32, 104, 97, 115, 32, 101, 120, 112, 105, 114, 101, 100, 46, 60, 47, 100, 105, 118, 62);
      ob_start();
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['initialize']      = false;
      } 
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao'], $this->root . $this->path_prod, 'inversoft'); 
      } 
      else 
      { 
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_usuarios', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO sc_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'grid_usuarios', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO sc_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'grid_usuarios', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_modal']))
      {
          $this->sc_init_menu = "x";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Gera_log_access'] = false;
      }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "id_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "nombre_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "email_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "password_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "estado_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "id_perfil";
...
//======= =========================
   ...
   { 
       ...
       {
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_proc_container'] = true;
       }
       $nm_saida = "";
...
// 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_psq']) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
