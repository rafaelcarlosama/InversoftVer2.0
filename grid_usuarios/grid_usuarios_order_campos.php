...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["id_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["id_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["id_usuario"] : "Id Usuario";
   $tab_ger_campos['nombre_usuario'] = "on";
   $tab_def_campos['nombre_usuario'] = "Nombre_Usuario";
   $tab_converte["Nombre_Usuario"]   = "nombre_usuario";
   $tab_labels["nombre_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombre_usuario"] : "Nombre Usuario";
   $tab_ger_campos['email_usuario'] = "on";
   $tab_def_campos['email_usuario'] = "Email_Usuario";
   $tab_converte["Email_Usuario"]   = "email_usuario";
   $tab_labels["email_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["email_usuario"] : "Email Usuario";
   $tab_ger_campos['password_usuario'] = "on";
   $tab_def_campos['password_usuario'] = "Password_Usuario";
   $tab_converte["Password_Usuario"]   = "password_usuario";
   $tab_labels["password_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["password_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["password_usuario"] : "Password Usuario";
   $tab_ger_campos['estado_usuario'] = "on";
   $tab_def_campos['estado_usuario'] = "Estado_Usuario";
   $tab_converte["Estado_Usuario"]   = "estado_usuario";
   $tab_labels["estado_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["estado_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["estado_usuario"] : "Estado Usuario";
   $tab_ger_campos['id_perfil'] = "on";
   $tab_def_campos['id_perfil'] = "Id_Perfil";
   $tab_converte["Id_Perfil"]   = "id_perfil";
   $tab_labels["id_perfil"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["id_perfil"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["id_perfil"] : "Id Perfil";
