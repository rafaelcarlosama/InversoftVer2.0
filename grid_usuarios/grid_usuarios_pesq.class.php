...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_password_usuario')
      {
          $password_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_password_usuario($password_usuario);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_usuario')
      {
          $id_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_usuario($id_usuario);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_usuario')
      {
          $nombre_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_usuario($nombre_usuario);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_email_usuario')
      {
          $email_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_email_usuario($email_usuario);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_password_usuario($password_usuario)
   {
      $password_usuario = substr($this->Db->qstr($password_usuario), 1, -1);
            $password_usuario_look = substr($this->Db->qstr($password_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Password_Usuario from " . $this->Ini->nm_tabela . " where  Password_Usuario like '%" . $password_usuario . "%'"; 
   ...
   function lookup_ajax_id_usuario($id_usuario)
   {
      $id_usuario = substr($this->Db->qstr($id_usuario), 1, -1);
            $id_usuario_look = substr($this->Db->qstr($id_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Usuario from " . $this->Ini->nm_tabela . " where   CAST (Id_Usuario AS TEXT)  like '%" . $id_usuario . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Usuario from " . $this->Ini->nm_tabela . " where  Id_Usuario like '%" . $id_usuario . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_nombre_usuario($nombre_usuario)
   {
      $nombre_usuario = substr($this->Db->qstr($nombre_usuario), 1, -1);
            $nombre_usuario_look = substr($this->Db->qstr($nombre_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Usuario from " . $this->Ini->nm_tabela . " where  Nombre_Usuario like '%" . $nombre_usuario . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_email_usuario($email_usuario)
   {
      $email_usuario = substr($this->Db->qstr($email_usuario), 1, -1);
            $email_usuario_look = substr($this->Db->qstr($email_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Email_Usuario from " . $this->Ini->nm_tabela . " where  Email_Usuario like '%" . $email_usuario . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_password_usuario_cond#NMF#' + search_get_sel_txt('SC_password_usuario_cond') + '@NMF@';
  str_out += 'SC_password_usuario#NMF#' + search_get_text('SC_password_usuario') + '@NMF@';
  str_out += 'id_ac_password_usuario#NMF#' + search_get_text('id_ac_password_usuario') + '@NMF@';
  str_out += 'SC_id_usuario_cond#NMF#' + search_get_sel_txt('SC_id_usuario_cond') + '@NMF@';
  str_out += 'SC_id_usuario#NMF#' + search_get_text('SC_id_usuario') + '@NMF@';
  str_out += 'id_ac_id_usuario#NMF#' + search_get_text('id_ac_id_usuario') + '@NMF@';
  str_out += 'SC_id_usuario_input_2#NMF#' + search_get_text('SC_id_usuario_input_2') + '@NMF@';
  str_out += 'SC_nombre_usuario_cond#NMF#' + search_get_sel_txt('SC_nombre_usuario_cond') + '@NMF@';
  str_out += 'SC_nombre_usuario#NMF#' + search_get_text('SC_nombre_usuario') + '@NMF@';
  str_out += 'id_ac_nombre_usuario#NMF#' + search_get_text('id_ac_nombre_usuario') + '@NMF@';
  str_out += 'SC_email_usuario_cond#NMF#' + search_get_sel_txt('SC_email_usuario_cond') + '@NMF@';
  str_out += 'SC_email_usuario#NMF#' + search_get_text('SC_email_usuario') + '@NMF@';
  str_out += 'id_ac_email_usuario#NMF#' + search_get_text('id_ac_email_usuario') + '@NMF@';
   ...
   $("#id_ac_id_usuario").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_usuario",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_usuario").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_usuario").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nombre_usuario").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_usuario",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nombre_usuario").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_usuario").val( $(this).val() );
       }
     }
   });
   $("#id_ac_email_usuario").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_email_usuario",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_email_usuario").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_email_usuario").val( $(this).val() );
       }
     }
   });
   $("#id_ac_password_usuario").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_password_usuario",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_password_usuario").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_password_usuario").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $password_usuario_cond, $password_usuario, $password_usuario_autocomp,
             $id_usuario_cond, $id_usuario, $id_usuario_input_2, $id_usuario_autocomp,
             $nombre_usuario_cond, $nombre_usuario, $nombre_usuario_autocomp,
             $email_usuario_cond, $email_usuario, $email_usuario_autocomp,
      ...
      { 
          ...
          $password_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['password_usuario']; 
          $password_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['password_usuario_cond']; 
          $id_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario']; 
          $id_usuario_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario_input_2']; 
          $id_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario_cond']; 
          $nombre_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_usuario']; 
          $nombre_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_usuario_cond']; 
          $email_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_usuario']; 
          $email_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_usuario_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['NM_operador']; 
      } 
      if (!isset($password_usuario_cond) || empty($password_usuario_cond))
      {
         $password_usuario_cond = "qp";
      }
      if (!isset($id_usuario_cond) || empty($id_usuario_cond))
      {
         $id_usuario_cond = "gt";
      }
      if (!isset($nombre_usuario_cond) || empty($nombre_usuario_cond))
      {
         $nombre_usuario_cond = "qp";
      }
      if (!isset($email_usuario_cond) || empty($email_usuario_cond))
      {
         $email_usuario_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_password_usuario = (in_array($password_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_usuario = (in_array($id_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_usuario = (in_array($nombre_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_email_usuario = (in_array($email_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_usuario = ('bw' == $id_usuario_cond) ? $display_aberto : $display_fechado;

      if (!isset($password_usuario) || $password_usuario == "")
      {
          $password_usuario = "";
      }
      if (isset($password_usuario) && !empty($password_usuario))
      {
         $tmp_pos = strpos($password_usuario, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $password_usuario = substr($password_usuario, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($nombre_usuario, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_usuario = substr($nombre_usuario, 0, $tmp_pos);
         }
      }
      ...
      if (isset($email_usuario) && !empty($email_usuario))
      {
         $tmp_pos = strpos($email_usuario, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $email_usuario = substr($email_usuario, 0, $tmp_pos);
         }
      }
?>
 <?php
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['password_usuario'])) ? $this->New_label['password_usuario'] : "Password Usuario"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_password_usuario_cond" name="password_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_password_usuario'), this, 'password_usuario')">
       <OPTION value="qp" <?php if ("qp" == $password_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $password_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $password_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $password_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_password_usuario" <?php echo $str_hide_password_usuario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['password_usuario'])) ? $this->New_label['password_usuario'] : "Password Usuario";
 $nmgp_tab_label .= "password_usuario?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $password_usuario_look = substr($this->Db->qstr($password_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Password_Usuario from " . $this->Ini->nm_tabela . " where Password_Usuario = '$password_usuario_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$password_usuario]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$password_usuario];
      }
      else
      {
          $sAutocompValue = $password_usuario;
      }
?>
<INPUT  type="text" id="SC_password_usuario" name="password_usuario" value="<?php echo NM_encode_input($password_usuario) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_password_usuario" name="password_usuario_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_usuario'])) ? $this->New_label['id_usuario'] : "Id Usuario"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_usuario_cond" name="id_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_usuario'), this, 'id_usuario')">
       <OPTION value="gt" <?php if ("gt" == $id_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Usuario from " . $this->Ini->nm_tabela . " where Id_Usuario = $id_usuario_look"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Usuario from " . $this->Ini->nm_tabela . " where Id_Usuario = $id_usuario_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_usuario]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_usuario];
      }
      else
      {
          $sAutocompValue = $id_usuario;
      }
?>
<INPUT  type="text" id="SC_id_usuario" name="id_usuario" value="<?php echo NM_encode_input($id_usuario) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_usuario" name="id_usuario_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_usuario"  <?php echo $str_display_id_usuario; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_usuario_input_2" name="id_usuario_input_2" value="<?php echo NM_encode_input($id_usuario_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_usuario'])) ? $this->New_label['nombre_usuario'] : "Nombre Usuario"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_usuario_cond" name="nombre_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_usuario'), this, 'nombre_usuario')">
       <OPTION value="qp" <?php if ("qp" == $nombre_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_usuario" <?php echo $str_hide_nombre_usuario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nombre_usuario'])) ? $this->New_label['nombre_usuario'] : "Nombre Usuario";
 $nmgp_tab_label .= "nombre_usuario?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $nombre_usuario_look = substr($this->Db->qstr($nombre_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Usuario from " . $this->Ini->nm_tabela . " where Nombre_Usuario = '$nombre_usuario_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nombre_usuario]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_usuario];
      }
      else
      {
          $sAutocompValue = $nombre_usuario;
      }
?>
<INPUT  type="text" id="SC_nombre_usuario" name="nombre_usuario" value="<?php echo NM_encode_input($nombre_usuario) ?>" size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_usuario" name="nombre_usuario_autocomp" size="40" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['email_usuario'])) ? $this->New_label['email_usuario'] : "Email Usuario"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_email_usuario_cond" name="email_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_email_usuario'), this, 'email_usuario')">
       <OPTION value="qp" <?php if ("qp" == $email_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $email_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $email_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $email_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_email_usuario" <?php echo $str_hide_email_usuario?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['email_usuario'])) ? $this->New_label['email_usuario'] : "Email Usuario";
 $nmgp_tab_label .= "email_usuario?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $email_usuario_look = substr($this->Db->qstr($email_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Email_Usuario from " . $this->Ini->nm_tabela . " where Email_Usuario = '$email_usuario_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$email_usuario]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$email_usuario];
      }
      else
      {
          $sAutocompValue = $email_usuario;
      }
?>
<INPUT  type="text" id="SC_email_usuario" name="email_usuario" value="<?php echo NM_encode_input($email_usuario) ?>" size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_email_usuario" name="email_usuario_autocomp" size="40" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_password_usuario'), document.F1.password_usuario_cond, 'password_usuario');
   document.F1.password_usuario.value = "";
   document.F1.password_usuario_autocomp.value = "";
   ...
   document.F1.id_usuario_autocomp.value = "";
   document.F1.id_usuario_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_nombre_usuario'), document.F1.nombre_usuario_cond, 'nombre_usuario');
   document.F1.nombre_usuario.value = "";
   document.F1.nombre_usuario_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_email_usuario'), document.F1.email_usuario_cond, 'email_usuario');
   document.F1.email_usuario.value = "";
   document.F1.email_usuario_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "inversoft/grid_usuarios";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_password_usuario_cond'] = 'cond';
      $tp_fields['SC_password_usuario'] = 'text_aut';
      $tp_fields['id_ac_password_usuario'] = 'text_aut';
      $tp_fields['SC_id_usuario_cond'] = 'cond';
      $tp_fields['SC_id_usuario'] = 'text_aut';
      $tp_fields['id_ac_id_usuario'] = 'text_aut';
      $tp_fields['SC_id_usuario_input_2'] = 'text';
      $tp_fields['SC_nombre_usuario_cond'] = 'cond';
      $tp_fields['SC_nombre_usuario'] = 'text_aut';
      $tp_fields['id_ac_nombre_usuario'] = 'text_aut';
      $tp_fields['SC_email_usuario_cond'] = 'cond';
      $tp_fields['SC_email_usuario'] = 'text_aut';
      $tp_fields['id_ac_email_usuario'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $password_usuario_cond, $password_usuario, $password_usuario_autocomp,
             $id_usuario_cond, $id_usuario, $id_usuario_input_2, $id_usuario_autocomp,
             $nombre_usuario_cond, $nombre_usuario, $nombre_usuario_autocomp,
             $email_usuario_cond, $email_usuario, $email_usuario_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($password_usuario_autocomp) && empty($password_usuario))
      {
          $password_usuario = $password_usuario_autocomp;
      }
      if (!empty($id_usuario_autocomp) && empty($id_usuario))
      {
          $id_usuario = $id_usuario_autocomp;
      }
      if (!empty($nombre_usuario_autocomp) && empty($nombre_usuario))
      {
          $nombre_usuario = $nombre_usuario_autocomp;
      }
      if (!empty($email_usuario_autocomp) && empty($email_usuario))
      {
          $email_usuario = $email_usuario_autocomp;
      }
      $password_usuario_cond_salva = $password_usuario_cond; 
      if (!isset($password_usuario_input_2) || $password_usuario_input_2 == "")
      {
          $password_usuario_input_2 = $password_usuario;
      }
      ...
      $nombre_usuario_cond_salva = $nombre_usuario_cond; 
      if (!isset($nombre_usuario_input_2) || $nombre_usuario_input_2 == "")
      {
          $nombre_usuario_input_2 = $nombre_usuario;
      }
      $email_usuario_cond_salva = $email_usuario_cond; 
      if (!isset($email_usuario_input_2) || $email_usuario_input_2 == "")
      {
          $email_usuario_input_2 = $email_usuario;
      }
      if ($id_usuario_cond != "in")
      {
          nm_limpa_numero($id_usuario, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_usuario);
          ...
          $id_usuario = implode(",", $Nm_sc_valores);
      }
      if ($id_usuario_cond != "in")
      {
          nm_limpa_numero($id_usuario_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['password_usuario'] = $password_usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['password_usuario_cond'] = $password_usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario'] = $id_usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario_input_2'] = $id_usuario_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['id_usuario_cond'] = $id_usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_usuario'] = $nombre_usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombre_usuario_cond'] = $nombre_usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_usuario'] = $email_usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['email_usuario_cond'] = $email_usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_usuario_cond != "in" && $id_usuario_cond != "bw" && !empty($id_usuario) && !is_numeric($id_usuario))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Usuario";
      }
      if ($id_usuario_cond == "bw" && ((!empty($id_usuario) && !is_numeric($id_usuario)) || (!empty($id_usuario_input_2) && !is_numeric($id_usuario_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Usuario";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['password_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['password_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['password_usuario'] = $password_usuario;
      }
      $id_usuario_look = substr($this->Db->qstr($id_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_usuario))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_usuario'] = $id_usuario;
      }
      $Conteudo = $id_usuario_input_2;
      if (strtoupper($id_usuario_cond) != "II" && strtoupper($id_usuario_cond) != "QP" && strtoupper($id_usuario_cond) != "NP" && strtoupper($id_usuario_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_usuario_input_2'] = $Conteudo;
      $nombre_usuario_look = substr($this->Db->qstr($nombre_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Usuario from " . $this->Ini->nm_tabela . " where Nombre_Usuario = '$nombre_usuario_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_usuario'] = $nombre_usuario;
      }
      $email_usuario_look = substr($this->Db->qstr($email_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Email_Usuario from " . $this->Ini->nm_tabela . " where Email_Usuario = '$email_usuario_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['email_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['email_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['email_usuario'] = $email_usuario;
      }

      //----- $password_usuario
      $this->Date_part = false;
      if (isset($password_usuario) || $password_usuario_cond == "nu" || $password_usuario_cond == "nn" || $password_usuario_cond == "ep" || $password_usuario_cond == "ne")
      {
         $this->monta_condicao("Password_Usuario", $password_usuario_cond, $password_usuario, "", "password_usuario");
      }

      //----- $id_usuario
      $this->Date_part = false;
      if (isset($id_usuario) || $id_usuario_cond == "nu" || $id_usuario_cond == "nn" || $id_usuario_cond == "ep" || $id_usuario_cond == "ne")
      {
         $this->monta_condicao("Id_Usuario", $id_usuario_cond, $id_usuario, $id_usuario_input_2, "id_usuario");
      }

      //----- $nombre_usuario
      $this->Date_part = false;
      if (isset($nombre_usuario) || $nombre_usuario_cond == "nu" || $nombre_usuario_cond == "nn" || $nombre_usuario_cond == "ep" || $nombre_usuario_cond == "ne")
      {
         $this->monta_condicao("Nombre_Usuario", $nombre_usuario_cond, $nombre_usuario, "", "nombre_usuario");
      }

      //----- $email_usuario
      $this->Date_part = false;
      if (isset($email_usuario) || $email_usuario_cond == "nu" || $email_usuario_cond == "nn" || $email_usuario_cond == "ep" || $email_usuario_cond == "ne")
      {
         $this->monta_condicao("Email_Usuario", $email_usuario_cond, $email_usuario, "", "email_usuario");
      }
   }
