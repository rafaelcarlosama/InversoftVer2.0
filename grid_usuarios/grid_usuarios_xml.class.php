...
class grid_usuarios_xml
{
   ...
   function NM_export_nombre_usuario()
   {
         ...
         $this->xml_registro .= " nombre_usuario =\"" . $this->trata_dados($this->nombre_usuario) . "\"";
   }
   //----- email_usuario
   function NM_export_email_usuario()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->email_usuario))
         {
             $this->email_usuario = sc_convert_encoding($this->email_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " email_usuario =\"" . $this->trata_dados($this->email_usuario) . "\"";
   }
   //----- password_usuario
   function NM_export_password_usuario()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->password_usuario))
         {
             $this->password_usuario = sc_convert_encoding($this->password_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " password_usuario =\"" . $this->trata_dados($this->password_usuario) . "\"";
   }
   //----- estado_usuario
   function NM_export_estado_usuario()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->estado_usuario))
         {
             $this->estado_usuario = sc_convert_encoding($this->estado_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " estado_usuario =\"" . $this->trata_dados($this->estado_usuario) . "\"";
   }
   //----- id_perfil
