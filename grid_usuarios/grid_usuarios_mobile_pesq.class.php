...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_usuario";$Nm_numeric[] = "estado_usuario";$Nm_numeric[] = "id_perfil";$Nm_numeric[] = "id_tipodoc";$Nm_numeric[] = "id_usuario";$Nm_numeric[] = "estado_usuario";$Nm_numeric[] = "id_perfil";$Nm_numeric[] = "id_tipodoc";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_password_usuario"  <?php echo $str_hide_password_usuario?>><?php
      $password_usuario_look = substr($this->Db->qstr($password_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_usuario"  <?php echo $str_hide_id_usuario?>><?php
      $id_usuario_look = substr($this->Db->qstr($id_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_usuario" name="id_usuario_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_usuario"  <?php echo $str_display_id_usuario; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_usuario_input_2" name="id_usuario_input_2" value="<?php echo NM_encode_input($id_usuario_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_usuario"  <?php echo $str_hide_nombre_usuario?>><?php
      $nombre_usuario_look = substr($this->Db->qstr($nombre_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_email_usuario"  <?php echo $str_hide_email_usuario?>><?php
      $email_usuario_look = substr($this->Db->qstr($email_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
