<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_ingreso_producto_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_ingreso_producto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['id_producto'] = "Id_Producto";
   $tab_converte["Id_Producto"]   = "id_producto";
   $tab_labels["id_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["id_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["id_producto"] : "Id Producto";
   $tab_ger_campos['id_proveedor'] = "on";
   $tab_def_campos['id_proveedor'] = "Id_Proveedor";
   $tab_converte["Id_Proveedor"]   = "id_proveedor";
   $tab_labels["id_proveedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["id_proveedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["id_proveedor"] : "Id Proveedor";
   $tab_ger_campos['cantidad_ingreso'] = "on";
   $tab_def_campos['cantidad_ingreso'] = "Cantidad_Ingreso";
   $tab_converte["Cantidad_Ingreso"]   = "cantidad_ingreso";
   $tab_labels["cantidad_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["cantidad_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["cantidad_ingreso"] : "Cantidad Ingreso";
   $tab_ger_campos['valor_unidad_ingreso'] = "on";
   $tab_def_campos['valor_unidad_ingreso'] = "Valor_Unidad_Ingreso";
   $tab_converte["Valor_Unidad_Ingreso"]   = "valor_unidad_ingreso";
   $tab_labels["valor_unidad_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["valor_unidad_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["valor_unidad_ingreso"] : "Valor Unidad Ingreso";
   $tab_ger_campos['fecha_ingreso'] = "on";
   $tab_def_campos['fecha_ingreso'] = "Fecha_Ingreso";
   $tab_converte["Fecha_Ingreso"]   = "fecha_ingreso";
   $tab_labels["fecha_ingreso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["fecha_ingreso"])) ? $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['labels']["fecha_ingreso"] : "Fecha Ingreso";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - ingreso_producto</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_ingreso_producto_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_ingreso_producto']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
