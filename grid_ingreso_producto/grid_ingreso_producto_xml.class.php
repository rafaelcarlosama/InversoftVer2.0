...
class grid_ingreso_producto_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_ingreso_producto_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_ingreso_producto.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_ingreso_producto";
   ...
   function NM_export_id_proveedor()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_proveedor))
         {
             $this->id_proveedor = sc_convert_encoding($this->id_proveedor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_proveedor =\"" . $this->trata_dados($this->id_proveedor) . "\"";
   }
   //----- cantidad_ingreso
   function NM_export_cantidad_ingreso()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cantidad_ingreso))
         {
             $this->cantidad_ingreso = sc_convert_encoding($this->cantidad_ingreso, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " cantidad_ingreso =\"" . $this->trata_dados($this->cantidad_ingreso) . "\"";
   }
   ...
   function NM_export_valor_unidad_ingreso()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->valor_unidad_ingreso))
         {
             $this->valor_unidad_ingreso = sc_convert_encoding($this->valor_unidad_ingreso, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " valor_unidad_ingreso =\"" . $this->trata_dados($this->valor_unidad_ingreso) . "\"";
   }
   //----- fecha_ingreso
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ingreso_producto']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - ingreso_producto :: XML</TITLE>
