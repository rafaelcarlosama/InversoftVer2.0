...
class grid_perfiles_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_perfiles_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_perfiles_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_perfiles_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_perfil')
      {
          $id_perfil = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_perfil($id_perfil);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_perfil')
      {
          $nombre_perfil = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_perfil($nombre_perfil);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_perfil($id_perfil)
   {
      $id_perfil = substr($this->Db->qstr($id_perfil), 1, -1);
            $id_perfil_look = substr($this->Db->qstr($id_perfil), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Perfil from " . $this->Ini->nm_tabela . " where   CAST (Id_Perfil AS TEXT)  like '%" . $id_perfil . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Perfil from " . $this->Ini->nm_tabela . " where  Id_Perfil like '%" . $id_perfil . "%'"; 
      }
   ...
   function lookup_ajax_nombre_perfil($nombre_perfil)
   {
      $nombre_perfil = substr($this->Db->qstr($nombre_perfil), 1, -1);
            $nombre_perfil_look = substr($this->Db->qstr($nombre_perfil), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Perfil from " . $this->Ini->nm_tabela . " where  Nombre_Perfil like '%" . $nombre_perfil . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - perfiles</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_perfiles/grid_perfiles_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_perfiles_ajax_search.js"></script>
 <script type="text/javascript" src="grid_perfiles_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_perfil_cond#NMF#' + search_get_sel_txt('SC_id_perfil_cond') + '@NMF@';
  str_out += 'SC_id_perfil#NMF#' + search_get_text('SC_id_perfil') + '@NMF@';
  str_out += 'id_ac_id_perfil#NMF#' + search_get_text('id_ac_id_perfil') + '@NMF@';
  str_out += 'SC_id_perfil_input_2#NMF#' + search_get_text('SC_id_perfil_input_2') + '@NMF@';
  str_out += 'SC_nombre_perfil_cond#NMF#' + search_get_sel_txt('SC_nombre_perfil_cond') + '@NMF@';
  str_out += 'SC_nombre_perfil#NMF#' + search_get_text('SC_nombre_perfil') + '@NMF@';
  str_out += 'id_ac_nombre_perfil#NMF#' + search_get_text('id_ac_nombre_perfil') + '@NMF@';
   ...
   $("#id_ac_id_perfil").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_perfil",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_perfil").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_perfil").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nombre_perfil").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_perfil",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nombre_perfil").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_perfil").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - perfiles</span></td>
...
<?php
   ...
   {
      global 
             $id_perfil_cond, $id_perfil, $id_perfil_input_2, $id_perfil_autocomp,
             $nombre_perfil_cond, $nombre_perfil, $nombre_perfil_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_perfil = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil']; 
          $id_perfil_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil_input_2']; 
          $id_perfil_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil_cond']; 
          $nombre_perfil = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['nombre_perfil']; 
          $nombre_perfil_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['nombre_perfil_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_perfil_cond) || empty($id_perfil_cond))
      {
         $id_perfil_cond = "gt";
      }
      if (!isset($nombre_perfil_cond) || empty($nombre_perfil_cond))
      {
         $nombre_perfil_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_id_perfil = (in_array($id_perfil_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_perfil = (in_array($nombre_perfil_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_perfil = ('bw' == $id_perfil_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_perfil) || $id_perfil == "")
      {
          $id_perfil = "";
      }
      if (isset($id_perfil) && !empty($id_perfil))
      {
         $tmp_pos = strpos($id_perfil, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_perfil = substr($id_perfil, 0, $tmp_pos);
         }
      }
      if (!isset($nombre_perfil) || $nombre_perfil == "")
      {
          $nombre_perfil = "";
      }
      if (isset($nombre_perfil) && !empty($nombre_perfil))
      {
         $tmp_pos = strpos($nombre_perfil, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_perfil = substr($nombre_perfil, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_perfiles_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_perfil'])) ? $this->New_label['id_perfil'] : "Id Perfil"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_perfil_cond" name="id_perfil_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_perfil'), this, 'id_perfil')">
       <OPTION value="gt" <?php if ("gt" == $id_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_perfil" <?php echo $str_hide_id_perfil?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_perfil'])) ? $this->New_label['id_perfil'] : "Id Perfil";
 $nmgp_tab_label .= "id_perfil?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_perfil_look = substr($this->Db->qstr($id_perfil), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Perfil from " . $this->Ini->nm_tabela . " where Id_Perfil = $id_perfil_look"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Perfil from " . $this->Ini->nm_tabela . " where Id_Perfil = $id_perfil_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_perfil]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_perfil];
      }
      else
      {
          $sAutocompValue = $id_perfil;
      }
?>
<INPUT  type="text" id="SC_id_perfil" name="id_perfil" value="<?php echo NM_encode_input($id_perfil) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_perfil" name="id_perfil_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_perfil"  <?php echo $str_display_id_perfil; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_perfil_input_2" name="id_perfil_input_2" value="<?php echo NM_encode_input($id_perfil_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre_perfil'])) ? $this->New_label['nombre_perfil'] : "Nombre Perfil"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nombre_perfil_cond" name="nombre_perfil_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_perfil'), this, 'nombre_perfil')">
       <OPTION value="qp" <?php if ("qp" == $nombre_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_perfil_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_perfil" <?php echo $str_hide_nombre_perfil?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nombre_perfil'])) ? $this->New_label['nombre_perfil'] : "Nombre Perfil";
 $nmgp_tab_label .= "nombre_perfil?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $nombre_perfil_look = substr($this->Db->qstr($nombre_perfil), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Perfil from " . $this->Ini->nm_tabela . " where Nombre_Perfil = '$nombre_perfil_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nombre_perfil]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_perfil];
      }
      else
      {
          $sAutocompValue = $nombre_perfil;
      }
?>
<INPUT  type="text" id="SC_nombre_perfil" name="nombre_perfil" value="<?php echo NM_encode_input($nombre_perfil) ?>" size=25 alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre_perfil" name="nombre_perfil_autocomp" size="25" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 25, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_perfiles']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_perfiles']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_perfil'), document.F1.id_perfil_cond, 'id_perfil');
   document.F1.id_perfil.value = "";
   document.F1.id_perfil_autocomp.value = "";
   document.F1.id_perfil_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_nombre_perfil'), document.F1.nombre_perfil_cond, 'nombre_perfil');
   document.F1.nombre_perfil.value = "";
   document.F1.nombre_perfil_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "inversoft/grid_perfiles";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_perfil_cond'] = 'cond';
      $tp_fields['SC_id_perfil'] = 'text_aut';
      $tp_fields['id_ac_id_perfil'] = 'text_aut';
      $tp_fields['SC_id_perfil_input_2'] = 'text';
      $tp_fields['SC_nombre_perfil_cond'] = 'cond';
      $tp_fields['SC_nombre_perfil'] = 'text_aut';
      $tp_fields['id_ac_nombre_perfil'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $id_perfil_cond, $id_perfil, $id_perfil_input_2, $id_perfil_autocomp,
             $nombre_perfil_cond, $nombre_perfil, $nombre_perfil_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_perfil_autocomp) && empty($id_perfil))
      {
          $id_perfil = $id_perfil_autocomp;
      }
      if (!empty($nombre_perfil_autocomp) && empty($nombre_perfil))
      {
          $nombre_perfil = $nombre_perfil_autocomp;
      }
      $id_perfil_cond_salva = $id_perfil_cond; 
      if (!isset($id_perfil_input_2) || $id_perfil_input_2 == "")
      {
          $id_perfil_input_2 = $id_perfil;
      }
      $nombre_perfil_cond_salva = $nombre_perfil_cond; 
      if (!isset($nombre_perfil_input_2) || $nombre_perfil_input_2 == "")
      {
          $nombre_perfil_input_2 = $nombre_perfil;
      }
      if ($id_perfil_cond != "in")
      {
          nm_limpa_numero($id_perfil, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_perfil);
          ...
          $id_perfil = implode(",", $Nm_sc_valores);
      }
      if ($id_perfil_cond != "in")
      {
          nm_limpa_numero($id_perfil_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil'] = $id_perfil; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil_input_2'] = $id_perfil_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['id_perfil_cond'] = $id_perfil_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['nombre_perfil'] = $nombre_perfil; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['nombre_perfil_cond'] = $nombre_perfil_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_perfil_cond != "in" && $id_perfil_cond != "bw" && !empty($id_perfil) && !is_numeric($id_perfil))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Perfil";
      }
      if ($id_perfil_cond == "bw" && ((!empty($id_perfil) && !is_numeric($id_perfil)) || (!empty($id_perfil_input_2) && !is_numeric($id_perfil_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Perfil";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_perfil'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_perfil'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_perfil'] = $id_perfil;
      }
      $Conteudo = $id_perfil_input_2;
      if (strtoupper($id_perfil_cond) != "II" && strtoupper($id_perfil_cond) != "QP" && strtoupper($id_perfil_cond) != "NP" && strtoupper($id_perfil_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_perfil_input_2'] = $Conteudo;
      $nombre_perfil_look = substr($this->Db->qstr($nombre_perfil), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Perfil from " . $this->Ini->nm_tabela . " where Nombre_Perfil = '$nombre_perfil_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_perfil'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_perfil'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_perfil'] = $nombre_perfil;
      }

      //----- $id_perfil
      $this->Date_part = false;
      if (isset($id_perfil) || $id_perfil_cond == "nu" || $id_perfil_cond == "nn" || $id_perfil_cond == "ep" || $id_perfil_cond == "ne")
      {
         $this->monta_condicao("Id_Perfil", $id_perfil_cond, $id_perfil, $id_perfil_input_2, "id_perfil");
      }

      //----- $nombre_perfil
      $this->Date_part = false;
      if (isset($nombre_perfil) || $nombre_perfil_cond == "nu" || $nombre_perfil_cond == "nn" || $nombre_perfil_cond == "ep" || $nombre_perfil_cond == "ne")
      {
         $this->monta_condicao("Nombre_Perfil", $nombre_perfil_cond, $nombre_perfil, "", "nombre_perfil");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_perfiles']['where_pesq_ant'] = $this->comando . $this->comando_fim;
