...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_categoria";$Nm_numeric[] = "id_categoria";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_categoria"  <?php echo $str_hide_id_categoria?>><?php
      $id_categoria_look = substr($this->Db->qstr($id_categoria), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_categoria" name="id_categoria_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_categoria"  <?php echo $str_display_id_categoria; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_categoria_input_2" name="id_categoria_input_2" value="<?php echo NM_encode_input($id_categoria_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_categoria"  <?php echo $str_hide_nombre_categoria?>><?php
      $nombre_categoria_look = substr($this->Db->qstr($nombre_categoria), 1, -1); 
      $nmgp_def_dados = array(); 
