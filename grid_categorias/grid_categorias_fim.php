...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["inversoft_____grid_categorias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["inversoft_____grid_categorias"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_categorias'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_categorias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_categorias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_categorias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_categorias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_categorias']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_categorias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_categorias']['embutida_filho'] as $ind => $sc_init)
          {
