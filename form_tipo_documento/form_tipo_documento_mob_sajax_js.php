  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_documento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_tipodoc
  function do_ajax_form_tipo_documento_mob_validate_id_tipodoc()
  {
    var nomeCampo_id_tipodoc = "id_tipodoc";
    var var_id_tipodoc = scAjaxGetFieldHidden(nomeCampo_id_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_documento_mob_validate_id_tipodoc(var_id_tipodoc, var_script_case_init, do_ajax_form_tipo_documento_mob_validate_id_tipodoc_cb);
  } // do_ajax_form_tipo_documento_mob_validate_id_tipodoc

  function do_ajax_form_tipo_documento_mob_validate_id_tipodoc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_documento_mob_validate_id_tipodoc_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipo_documento_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_documento_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipo_documento_mob_validate_descripcion_cb);
  } // do_ajax_form_tipo_documento_mob_validate_descripcion

  function do_ajax_form_tipo_documento_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_documento_mob_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_tipo_documento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_documento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_tipodoc = scAjaxGetFieldHidden("id_tipodoc");
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_documento_mob_submit_form(var_id_tipodoc, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_documento_mob_submit_form_cb);
  } // do_ajax_form_tipo_documento_mob_submit_form

  function do_ajax_form_tipo_documento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tipo_documento_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_documento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_tipodoc");
    scAjaxHideErrorDisplay("descripcion");
    var var_id_tipodoc = document.F2.id_tipodoc.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_documento_mob_navigate_form(var_id_tipodoc, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_documento_mob_navigate_form_cb);
  } // do_ajax_form_tipo_documento_mob_navigate_form

  function do_ajax_form_tipo_documento_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tipo_documento_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_tipodoc.value = scAjaxGetKeyValue("id_tipodoc");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tipo_documento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tipo_documento_mob_navigate_form_cb
  function sc_hide_form_tipo_documento_mob_form()
  {
