...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_cliente";$Nm_numeric[] = "id_usuario";$Nm_numeric[] = "id_cliente";$Nm_numeric[] = "id_usuario";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_telefono_celular_cliente"  <?php echo $str_hide_telefono_celular_cliente?>><?php
      $telefono_celular_cliente_look = substr($this->Db->qstr($telefono_celular_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_cliente"  <?php echo $str_hide_id_cliente?>><?php
      $id_cliente_look = substr($this->Db->qstr($id_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_cliente" name="id_cliente_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_cliente"  <?php echo $str_display_id_cliente; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_cliente_input_2" name="id_cliente_input_2" value="<?php echo NM_encode_input($id_cliente_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nombre_cliente"  <?php echo $str_hide_nombre_cliente?>><?php
      $nombre_cliente_look = substr($this->Db->qstr($nombre_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_telefono_fijo_cliente"  <?php echo $str_hide_telefono_fijo_cliente?>><?php
      $telefono_fijo_cliente_look = substr($this->Db->qstr($telefono_fijo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
