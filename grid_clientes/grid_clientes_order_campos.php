...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["Id_Cliente"]   = "id_cliente";
   $tab_labels["id_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_cliente"] : "Id Cliente";
   $tab_ger_campos['nombre_cliente'] = "on";
   $tab_def_campos['nombre_cliente'] = "Nombre_Cliente";
   $tab_converte["Nombre_Cliente"]   = "nombre_cliente";
   $tab_labels["nombre_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombre_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["nombre_cliente"] : "Nombre Cliente";
   $tab_ger_campos['telefono_fijo_cliente'] = "on";
   $tab_def_campos['telefono_fijo_cliente'] = "Telefono_Fijo_Cliente";
   $tab_converte["Telefono_Fijo_Cliente"]   = "telefono_fijo_cliente";
   $tab_labels["telefono_fijo_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_fijo_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_fijo_cliente"] : "Telefono Fijo Cliente";
   $tab_ger_campos['telefono_celular_cliente'] = "on";
   $tab_def_campos['telefono_celular_cliente'] = "Telefono_Celular_Cliente";
   $tab_converte["Telefono_Celular_Cliente"]   = "telefono_celular_cliente";
   $tab_labels["telefono_celular_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_celular_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["telefono_celular_cliente"] : "Telefono Celular Cliente";
   $tab_ger_campos['direccion_cliente'] = "on";
   $tab_def_campos['direccion_cliente'] = "Direccion_Cliente";
   $tab_converte["Direccion_Cliente"]   = "direccion_cliente";
   $tab_labels["direccion_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["direccion_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["direccion_cliente"] : "Direccion Cliente";
   $tab_ger_campos['id_usuario'] = "on";
   $tab_def_campos['id_usuario'] = "Id_Usuario";
   $tab_converte["Id_Usuario"]   = "id_usuario";
   $tab_labels["id_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["id_usuario"] : "Id Usuario";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - clientes</TITLE>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_clientes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
