...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono_celular_cliente')
      {
          $telefono_celular_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono_celular_cliente($telefono_celular_cliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_cliente')
      {
          $id_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_cliente($id_cliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_telefono_fijo_cliente')
      {
          $telefono_fijo_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_telefono_fijo_cliente($telefono_fijo_cliente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_telefono_celular_cliente($telefono_celular_cliente)
   {
      $telefono_celular_cliente = substr($this->Db->qstr($telefono_celular_cliente), 1, -1);
            $telefono_celular_cliente_look = substr($this->Db->qstr($telefono_celular_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Celular_Cliente from " . $this->Ini->nm_tabela . " where  Telefono_Celular_Cliente like '%" . $telefono_celular_cliente . "%'"; 
   ...
   function lookup_ajax_id_cliente($id_cliente)
   {
      $id_cliente = substr($this->Db->qstr($id_cliente), 1, -1);
            $id_cliente_look = substr($this->Db->qstr($id_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Cliente from " . $this->Ini->nm_tabela . " where   CAST (Id_Cliente AS TEXT)  like '%" . $id_cliente . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Cliente from " . $this->Ini->nm_tabela . " where  Id_Cliente like '%" . $id_cliente . "%'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_nombre_cliente($nombre_cliente)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Cliente from " . $this->Ini->nm_tabela . " where  Nombre_Cliente like '%" . $nombre_cliente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_telefono_fijo_cliente($telefono_fijo_cliente)
   {
      $telefono_fijo_cliente = substr($this->Db->qstr($telefono_fijo_cliente), 1, -1);
            $telefono_fijo_cliente_look = substr($this->Db->qstr($telefono_fijo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Fijo_Cliente from " . $this->Ini->nm_tabela . " where  Telefono_Fijo_Cliente like '%" . $telefono_fijo_cliente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_cliente";$Nm_numeric[] = "id_usuario";
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - clientes</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_telefono_celular_cliente_cond#NMF#' + search_get_sel_txt('SC_telefono_celular_cliente_cond') + '@NMF@';
  str_out += 'SC_telefono_celular_cliente#NMF#' + search_get_text('SC_telefono_celular_cliente') + '@NMF@';
  str_out += 'id_ac_telefono_celular_cliente#NMF#' + search_get_text('id_ac_telefono_celular_cliente') + '@NMF@';
  ...
  str_out += 'id_ac_id_cliente#NMF#' + search_get_text('id_ac_id_cliente') + '@NMF@';
  str_out += 'SC_id_cliente_input_2#NMF#' + search_get_text('SC_id_cliente_input_2') + '@NMF@';
  ...
  str_out += 'id_ac_nombre_cliente#NMF#' + search_get_text('id_ac_nombre_cliente') + '@NMF@';
  str_out += 'SC_telefono_fijo_cliente_cond#NMF#' + search_get_sel_txt('SC_telefono_fijo_cliente_cond') + '@NMF@';
  str_out += 'SC_telefono_fijo_cliente#NMF#' + search_get_text('SC_telefono_fijo_cliente') + '@NMF@';
  str_out += 'id_ac_telefono_fijo_cliente#NMF#' + search_get_text('id_ac_telefono_fijo_cliente') + '@NMF@';
   ...
   $("#id_ac_id_cliente").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_cliente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_cliente").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nombre_cliente").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
     ...
     select: function (event, ui) {
       $("#SC_nombre_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_cliente").val( $(this).val() );
       }
     }
   });
   $("#id_ac_telefono_fijo_cliente").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono_fijo_cliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_telefono_fijo_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_telefono_fijo_cliente").val( $(this).val() );
       }
     }
   });
   $("#id_ac_telefono_celular_cliente").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_telefono_celular_cliente",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_telefono_celular_cliente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_telefono_celular_cliente").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - clientes</span></td>
...
<?php
   ...
   {
      global 
             $telefono_celular_cliente_cond, $telefono_celular_cliente, $telefono_celular_cliente_autocomp,
             $id_cliente_cond, $id_cliente, $id_cliente_input_2, $id_cliente_autocomp,
             $nombre_cliente_cond, $nombre_cliente, $nombre_cliente_autocomp,
             $telefono_fijo_cliente_cond, $telefono_fijo_cliente, $telefono_fijo_cliente_autocomp,
      ...
      { 
          ...
          $telefono_celular_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_celular_cliente']; 
          $telefono_celular_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_celular_cliente_cond']; 
          $id_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente']; 
          $id_cliente_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente_input_2']; 
          $id_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente_cond']; 
          $nombre_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombre_cliente']; 
          $nombre_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombre_cliente_cond']; 
          $telefono_fijo_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_fijo_cliente']; 
          $telefono_fijo_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_fijo_cliente_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['NM_operador']; 
      } 
      if (!isset($telefono_celular_cliente_cond) || empty($telefono_celular_cliente_cond))
      {
         $telefono_celular_cliente_cond = "qp";
      }
      ...
      if (!isset($telefono_fijo_cliente_cond) || empty($telefono_fijo_cliente_cond))
      {
         $telefono_fijo_cliente_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_telefono_celular_cliente = (in_array($telefono_celular_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_telefono_fijo_cliente = (in_array($telefono_fijo_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_cliente = ('bw' == $id_cliente_cond) ? $display_aberto : $display_fechado;

      if (!isset($telefono_celular_cliente) || $telefono_celular_cliente == "")
      {
          $telefono_celular_cliente = "";
      }
      if (isset($telefono_celular_cliente) && !empty($telefono_celular_cliente))
      {
         $tmp_pos = strpos($telefono_celular_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono_celular_cliente = substr($telefono_celular_cliente, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($telefono_fijo_cliente) || $telefono_fijo_cliente == "")
      {
          $telefono_fijo_cliente = "";
      }
      if (isset($telefono_fijo_cliente) && !empty($telefono_fijo_cliente))
      {
         $tmp_pos = strpos($telefono_fijo_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $telefono_fijo_cliente = substr($telefono_fijo_cliente, 0, $tmp_pos);
         }
      }
?>
 <?php
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['telefono_celular_cliente'])) ? $this->New_label['telefono_celular_cliente'] : "Telefono Celular Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_telefono_celular_cliente_cond" name="telefono_celular_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_celular_cliente'), this, 'telefono_celular_cliente')">
       <OPTION value="qp" <?php if ("qp" == $telefono_celular_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_celular_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_celular_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_celular_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono_celular_cliente" <?php echo $str_hide_telefono_celular_cliente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['telefono_celular_cliente'])) ? $this->New_label['telefono_celular_cliente'] : "Telefono Celular Cliente";
 $nmgp_tab_label .= "telefono_celular_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $telefono_celular_cliente_look = substr($this->Db->qstr($telefono_celular_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Celular_Cliente from " . $this->Ini->nm_tabela . " where Telefono_Celular_Cliente = '$telefono_celular_cliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$telefono_celular_cliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$telefono_celular_cliente];
      }
      else
      {
          $sAutocompValue = $telefono_celular_cliente;
      }
?>
<INPUT  type="text" id="SC_telefono_celular_cliente" name="telefono_celular_cliente" value="<?php echo NM_encode_input($telefono_celular_cliente) ?>" size=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_telefono_celular_cliente" name="telefono_celular_cliente_autocomp" size="40" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 40, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_cliente'])) ? $this->New_label['id_cliente'] : "Id Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_cliente_cond" name="id_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente'), this, 'id_cliente')">
       ...
       <OPTION value="bw" <?php if ("bw" == $id_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Id_Cliente from " . $this->Ini->nm_tabela . " where Id_Cliente = $id_cliente_look"; 
      }
      else
      {
          $nm_comando = "select distinct Id_Cliente from " . $this->Ini->nm_tabela . " where Id_Cliente = $id_cliente_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_cliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_cliente];
      }
      else
      {
          $sAutocompValue = $id_cliente;
      }
?>
<INPUT  type="text" id="SC_id_cliente" name="id_cliente" value="<?php echo NM_encode_input($id_cliente) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_id_cliente" name="id_cliente_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_cliente"  <?php echo $str_display_id_cliente; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_cliente_input_2" name="id_cliente_input_2" value="<?php echo NM_encode_input($id_cliente_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['nombre_cliente'])) ? $this->New_label['nombre_cliente'] : "Nombre Cliente"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nombre_cliente_cond" name="nombre_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombre_cliente'), this, 'nombre_cliente')">
       <OPTION value="qp" <?php if ("qp" == $nombre_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nombre_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nombre_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nombre_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_cliente" <?php echo $str_hide_nombre_cliente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      $nombre_cliente_look = substr($this->Db->qstr($nombre_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Cliente from " . $this->Ini->nm_tabela . " where Nombre_Cliente = '$nombre_cliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_nombre_cliente" name="nombre_cliente" value="<?php echo NM_encode_input($nombre_cliente) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre_cliente" name="nombre_cliente_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['telefono_fijo_cliente'])) ? $this->New_label['telefono_fijo_cliente'] : "Telefono Fijo Cliente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_telefono_fijo_cliente_cond" name="telefono_fijo_cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_telefono_fijo_cliente'), this, 'telefono_fijo_cliente')">
       <OPTION value="qp" <?php if ("qp" == $telefono_fijo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $telefono_fijo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $telefono_fijo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $telefono_fijo_cliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_telefono_fijo_cliente" <?php echo $str_hide_telefono_fijo_cliente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['telefono_fijo_cliente'])) ? $this->New_label['telefono_fijo_cliente'] : "Telefono Fijo Cliente";
 $nmgp_tab_label .= "telefono_fijo_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $telefono_fijo_cliente_look = substr($this->Db->qstr($telefono_fijo_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Telefono_Fijo_Cliente from " . $this->Ini->nm_tabela . " where Telefono_Fijo_Cliente = '$telefono_fijo_cliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$telefono_fijo_cliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$telefono_fijo_cliente];
      }
      else
      {
          $sAutocompValue = $telefono_fijo_cliente;
      }
?>
<INPUT  type="text" id="SC_telefono_fijo_cliente" name="telefono_fijo_cliente" value="<?php echo NM_encode_input($telefono_fijo_cliente) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_telefono_fijo_cliente" name="telefono_fijo_cliente_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_telefono_celular_cliente'), document.F1.telefono_celular_cliente_cond, 'telefono_celular_cliente');
   document.F1.telefono_celular_cliente.value = "";
   document.F1.telefono_celular_cliente_autocomp.value = "";
   ...
   document.F1.id_cliente_autocomp.value = "";
   document.F1.id_cliente_input_2.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_telefono_fijo_cliente'), document.F1.telefono_fijo_cliente_cond, 'telefono_fijo_cliente');
   document.F1.telefono_fijo_cliente.value = "";
   document.F1.telefono_fijo_cliente_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "inversoft/grid_clientes";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_telefono_celular_cliente_cond'] = 'cond';
      $tp_fields['SC_telefono_celular_cliente'] = 'text_aut';
      $tp_fields['id_ac_telefono_celular_cliente'] = 'text_aut';
      $tp_fields['SC_id_cliente_cond'] = 'cond';
      $tp_fields['SC_id_cliente'] = 'text_aut';
      $tp_fields['id_ac_id_cliente'] = 'text_aut';
      $tp_fields['SC_id_cliente_input_2'] = 'text';
      $tp_fields['SC_nombre_cliente_cond'] = 'cond';
      $tp_fields['SC_nombre_cliente'] = 'text_aut';
      $tp_fields['id_ac_nombre_cliente'] = 'text_aut';
      $tp_fields['SC_telefono_fijo_cliente_cond'] = 'cond';
      $tp_fields['SC_telefono_fijo_cliente'] = 'text_aut';
      $tp_fields['id_ac_telefono_fijo_cliente'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $telefono_celular_cliente_cond, $telefono_celular_cliente, $telefono_celular_cliente_autocomp,
             $id_cliente_cond, $id_cliente, $id_cliente_input_2, $id_cliente_autocomp,
             $nombre_cliente_cond, $nombre_cliente, $nombre_cliente_autocomp,
             $telefono_fijo_cliente_cond, $telefono_fijo_cliente, $telefono_fijo_cliente_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($telefono_celular_cliente_autocomp) && empty($telefono_celular_cliente))
      {
          $telefono_celular_cliente = $telefono_celular_cliente_autocomp;
      }
      if (!empty($id_cliente_autocomp) && empty($id_cliente))
      {
          $id_cliente = $id_cliente_autocomp;
      }
      if (!empty($nombre_cliente_autocomp) && empty($nombre_cliente))
      {
          $nombre_cliente = $nombre_cliente_autocomp;
      }
      if (!empty($telefono_fijo_cliente_autocomp) && empty($telefono_fijo_cliente))
      {
          $telefono_fijo_cliente = $telefono_fijo_cliente_autocomp;
      }
      $telefono_celular_cliente_cond_salva = $telefono_celular_cliente_cond; 
      if (!isset($telefono_celular_cliente_input_2) || $telefono_celular_cliente_input_2 == "")
      {
          $telefono_celular_cliente_input_2 = $telefono_celular_cliente;
      }
      ...
      $telefono_fijo_cliente_cond_salva = $telefono_fijo_cliente_cond; 
      if (!isset($telefono_fijo_cliente_input_2) || $telefono_fijo_cliente_input_2 == "")
      {
          $telefono_fijo_cliente_input_2 = $telefono_fijo_cliente;
      }
      ...
      {
          $Nm_sc_valores = explode(",", $id_cliente);
          ...
          $id_cliente = implode(",", $Nm_sc_valores);
      }
      if ($id_cliente_cond != "in")
      {
          nm_limpa_numero($id_cliente_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_celular_cliente'] = $telefono_celular_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_celular_cliente_cond'] = $telefono_celular_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente'] = $id_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente_input_2'] = $id_cliente_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['id_cliente_cond'] = $id_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombre_cliente'] = $nombre_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['nombre_cliente_cond'] = $nombre_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_fijo_cliente'] = $telefono_fijo_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['telefono_fijo_cliente_cond'] = $telefono_fijo_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_cliente_cond != "in" && $id_cliente_cond != "bw" && !empty($id_cliente) && !is_numeric($id_cliente))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Cliente";
      }
      if ($id_cliente_cond == "bw" && ((!empty($id_cliente) && !is_numeric($id_cliente)) || (!empty($id_cliente_input_2) && !is_numeric($id_cliente_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Cliente";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono_celular_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['telefono_celular_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono_celular_cliente'] = $telefono_celular_cliente;
      }
      $id_cliente_look = substr($this->Db->qstr($id_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_cliente))
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['id_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_cliente'] = $id_cliente;
      }
      $Conteudo = $id_cliente_input_2;
      ...
      $this->cmp_formatado['id_cliente_input_2'] = $Conteudo;
      $nombre_cliente_look = substr($this->Db->qstr($nombre_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombre_Cliente from " . $this->Ini->nm_tabela . " where Nombre_Cliente = '$nombre_cliente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['telefono_fijo_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['telefono_fijo_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['telefono_fijo_cliente'] = $telefono_fijo_cliente;
      }

      //----- $telefono_celular_cliente
      $this->Date_part = false;
      if (isset($telefono_celular_cliente) || $telefono_celular_cliente_cond == "nu" || $telefono_celular_cliente_cond == "nn" || $telefono_celular_cliente_cond == "ep" || $telefono_celular_cliente_cond == "ne")
      {
         $this->monta_condicao("Telefono_Celular_Cliente", $telefono_celular_cliente_cond, $telefono_celular_cliente, "", "telefono_celular_cliente");
      }
      ...
      {
         $this->monta_condicao("Id_Cliente", $id_cliente_cond, $id_cliente, $id_cliente_input_2, "id_cliente");
      }
      ...
      //----- $telefono_fijo_cliente
      $this->Date_part = false;
      if (isset($telefono_fijo_cliente) || $telefono_fijo_cliente_cond == "nu" || $telefono_fijo_cliente_cond == "nn" || $telefono_fijo_cliente_cond == "ep" || $telefono_fijo_cliente_cond == "ne")
      {
         $this->monta_condicao("Telefono_Fijo_Cliente", $telefono_fijo_cliente_cond, $telefono_fijo_cliente, "", "telefono_fijo_cliente");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes']['where_pesq_ant'] = $this->comando . $this->comando_fim;
