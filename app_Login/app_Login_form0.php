...
<?php
$str_iframe_body = 'margin-top: 180px;';
...
<TR align="center">
 <TD colspan="3">
     <table  style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%" cellpadding="0" cellspacing="0">
       <tr valign="middle">
         <td align="left" ><span class="scFormHeaderFont"> <IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/sys__NM__bg__NM__logoInversoftTrasparenteIndex.png" BORDER="0"/> </span></td>
