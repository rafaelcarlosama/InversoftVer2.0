  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pedido_producto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_pedido_producto_mob_validate_id_producto()
  {
    var nomeCampo_id_producto = "id_producto";
    var var_id_producto = scAjaxGetFieldSelect(nomeCampo_id_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_producto_mob_validate_id_producto(var_id_producto, var_script_case_init, do_ajax_form_pedido_producto_mob_validate_id_producto_cb);
  } // do_ajax_form_pedido_producto_mob_validate_id_producto

  function do_ajax_form_pedido_producto_mob_validate_id_producto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_producto_mob_validate_id_producto_cb

  // ---------- Validate id_pedido
  function do_ajax_form_pedido_producto_mob_validate_id_pedido()
  {
    var nomeCampo_id_pedido = "id_pedido";
    var var_id_pedido = scAjaxGetFieldSelect(nomeCampo_id_pedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_producto_mob_validate_id_pedido(var_id_pedido, var_script_case_init, do_ajax_form_pedido_producto_mob_validate_id_pedido_cb);
  } // do_ajax_form_pedido_producto_mob_validate_id_pedido

  function do_ajax_form_pedido_producto_mob_validate_id_pedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_producto_mob_validate_id_pedido_cb
  // ---------- Form
  function do_ajax_form_pedido_producto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pedido_producto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_producto = scAjaxGetFieldSelect("id_producto");
    var var_id_pedido = scAjaxGetFieldSelect("id_pedido");
    ...
    scAjaxProcOn();
    x_ajax_form_pedido_producto_mob_submit_form(var_id_producto, var_id_pedido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pedido_producto_mob_submit_form_cb);
  } // do_ajax_form_pedido_producto_mob_submit_form

  function do_ajax_form_pedido_producto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_pedido_producto_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_pedido_producto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_pedido_producto_mob_navigate_form(var_id_producto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pedido_producto_mob_navigate_form_cb);
  } // do_ajax_form_pedido_producto_mob_navigate_form

  function do_ajax_form_pedido_producto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_pedido_producto_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_pedido_producto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_pedido_producto_mob_navigate_form_cb
  function sc_hide_form_pedido_producto_mob_form()
  {
